...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Batch convert Apple HEIC, HEIF, and AVIF images to standard JPG or PNG formats instantly and securely in your browser with zero server uploads.",
    url: "https://www.twistertools.com/tools/image-tools/heic-to-jpg",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/image-tools/heic-to-jpg.jpg",
        width: 1200,
        height: 630,
        alt: "Next-Gen HEIC & AVIF Image Converter on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Batch convert Apple HEIC, HEIF, and AVIF images to standard JPG or PNG formats instantly and securely in your browser with zero server uploads.",
    images: [
      "https://www.twistertools.com/images/tools/image-tools/heic-to-jpg.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/image-tools/heic-to-jpg",
  },
};

const HeicToJpgPage: NextPage = () => {
  return (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/heic-to-jpg")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/heic-to-jpg")}&text=${encodeURIComponent("Check out this free HEIC & AVIF Image Converter tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/heic-to-jpg")}`}
                    target="_blank"
                    rel="noopener noreferrer"
