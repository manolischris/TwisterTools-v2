...
import ImageToBase64Converter from "@/components/tools/ImageToBase64Converter";
import RelatedTools from "@/components/RelatedTools";
import fs from "fs";
import path from "path";

const TOOL_TITLE = "Image to Base64 String Data URI Encoder";
const TOOL_SLUG = "image-to-base64-converter";
...
const ImageToBase64ConverterPage: NextPage = () => {
  return (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/image-to-base64-converter")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/image-to-base64-converter")}&text=${encodeURIComponent("Check out this free Image to Base64 String Data URI Encoder tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/image-to-base64-converter")}`}
                    target="_blank"
                    rel="noopener noreferrer"
