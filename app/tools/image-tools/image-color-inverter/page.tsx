...
const TOOL_TITLE = "Image Color Inverter & Negative Filter";
const TOOL_SLUG = "image-color-inverter";
...
const ImageColorInverterPage: NextPage = () => {
  return (
...
export default ImageColorInverterPage;
