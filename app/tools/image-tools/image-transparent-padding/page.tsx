...
const TOOL_TITLE = "PNG Transparent Pixel Padding & Border Expander";
const TOOL_SLUG = "image-transparent-padding";
...
const ImageTransparentPaddingPage: NextPage = () => {
  return (
...
export default ImageTransparentPaddingPage;
