...
import GradientWallpaperGenerator from "@/components/tools/GradientWallpaperGenerator";
import RelatedTools from "@/components/RelatedTools";
import fs from "fs";
import path from "path";

const TOOL_TITLE = "Canvas Color Gradient Generator & High-Res PNG Exporter";
const TOOL_SLUG = "gradient-wallpaper-generator";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...
      "linear gradient exporter",
      "radial gradient generator",
      "conic gradient generator",
      "css gradient to png",
      "high res png wallpaper",
...
const GradientWallpaperGeneratorPage: NextPage = () => {
  return (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/gradient-wallpaper-generator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/gradient-wallpaper-generator")}&text=${encodeURIComponent("Check out this free Canvas Color Gradient Generator & High-Res PNG Exporter tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/gradient-wallpaper-generator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
...
export default GradientWallpaperGeneratorPage;
