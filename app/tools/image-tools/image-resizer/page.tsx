...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Image Resizer & Pixel Dimensions Scaler | TwisterTools",
    description:
      "Batch scale pixel dimensions, lock aspect ratios, and optimize web graphics locally using high-performance browser canvas rendering.",
    url: "https://www.twistertools.com/tools/image-tools/image-resizer",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/image-tools/image-resizer.jpg",
        width: 1200,
        height: 630,
        alt: "Image Resizer & Pixel Dimensions Scaler on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Batch scale pixel dimensions, lock aspect ratios, and optimize web graphics locally using high-performance browser canvas rendering.",
    images: [
      "https://www.twistertools.com/images/tools/image-tools/image-resizer.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/image-tools/image-resizer",
  },
};

const ImageResizerPage: NextPage = () => {
  return (
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-indigo-200/80 bg-gradient-to-br from-indigo-50 to-white p-1 shadow-xs shadow-indigo-100/60 dark:border-indigo-900/50 dark:from-slate-800 dark:to-slate-900 sm:h-14 sm:w-14 sm:rounded-2xl sm:p-2">
                <Scaling className="h-6 w-6 text-indigo-600 dark:text-indigo-400 sm:h-9 sm:w-9" />
              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/image-resizer")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/image-resizer")}&text=${encodeURIComponent("Check out this free Image Resizer & Pixel Dimensions Scaler tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/image-resizer")}`}
                    target="_blank"
                    rel="noopener noreferrer"
