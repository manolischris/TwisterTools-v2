...
import PixelArtScaler from "@/components/tools/PixelArtScaler";
import RelatedTools from "@/components/RelatedTools";
import fs from "fs";
import path from "path";

const TOOL_TITLE = "Pixel Art Sprite Scaler & Nearest-Neighbor Resizer";
const TOOL_SLUG = "pixel-art-scaler";
...
const PixelArtScalerPage: NextPage = () => {
  return (
...
export default PixelArtScalerPage;
