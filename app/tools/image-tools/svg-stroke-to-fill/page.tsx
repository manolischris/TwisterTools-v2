...
import SvgStrokeToFill from "@/components/tools/SvgStrokeToFill";
import RelatedTools from "@/components/RelatedTools";
import fs from "fs";
import path from "path";

const TOOL_TITLE = "SVG Stroke to Filled Outline Converter";
const TOOL_SLUG = "svg-stroke-to-fill";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...
      "expand stroke svg",
      "svg outline generator",
      "vector outline converter",
      "svg stroke to filled polygon",
      "convert line to filled shape svg",
      "twistertools",
    ],
    alternates: {
...
const SvgStrokeToFillPage: NextPage = () => {
  return (
...
export default SvgStrokeToFillPage;
