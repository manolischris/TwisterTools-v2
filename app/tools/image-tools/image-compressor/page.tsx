...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Image Compressor & Quality Optimizer | TwisterTools",
    description:
      "Batch compress and optimize PNG, JPG, WebP, and GIF assets locally in your browser. Fine-tune compression ratios, apply custom transparency fills, and scale pixel dimensions with zero server uploads.",
    url: "https://www.twistertools.com/tools/image-tools/image-compressor",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/image-tools/image-compressor.jpg",
        width: 1200,
        height: 630,
        alt: "Image Compressor & Quality Optimizer on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Batch compress and optimize PNG, JPG, WebP, and GIF assets locally in your browser. Fine-tune compression ratios, apply custom transparency fills, and scale pixel dimensions with zero server uploads.",
    images: [
      "https://www.twistertools.com/images/tools/image-tools/image-compressor.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/image-tools/image-compressor",
  },
};

const ImageCompressorPage: NextPage = () => {
  return (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/image-compressor")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/image-compressor")}&text=${encodeURIComponent("Check out this free Image Compressor & Quality Optimizer tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/image-tools/image-compressor")}`}
                    target="_blank"
                    rel="noopener noreferrer"
