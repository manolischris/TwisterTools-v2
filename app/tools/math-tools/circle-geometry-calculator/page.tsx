...
import CircleGeometryCalculator from "@/components/tools/CircleGeometryCalculator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";
import fs from "fs";
import path from "path";

const TOOL_TITLE = "Circle Circumference, Arc Length & Sector Area Calculator";
const TOOL_SLUG = "circle-geometry-calculator";
const TOOL_DESCRIPTION = "Solve circle radius, circumference, area, arc length, chord, and sector parameters with real-time vector visualization.";
const TOOL_META_DESCRIPTION = "Free circle geometry calculator solving circumference, area, arc length, sector area, chord length, sagitta, and segment area with dynamic real-time SVG vector rendering.";
...
export default function CircleGeometryCalculatorPage() {
  return (
