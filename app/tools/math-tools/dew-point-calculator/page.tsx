...
const TOOL_TITLE = "Dew Point & Relative Humidity Equilibrium Calculator";
const TOOL_SLUG = "dew-point-calculator";
const TOOL_DESCRIPTION = "Calculate equilibrium dew point temperatures, relative humidity, vapor pressure deficit (VPD), absolute humidity, enthalpy, and surface condensation risk using Arden Buck and Magnus-Tetens thermodynamic equations.";
const TOOL_META_DESCRIPTION = "Thermodynamic solver for dew point, relative humidity, vapor pressure deficit (VPD), absolute humidity, enthalpy, and surface condensation thresholds using Arden Buck and Magnus-Tetens equations.";
