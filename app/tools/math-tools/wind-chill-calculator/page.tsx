...
const TOOL_TITLE = "Wind Chill Factor & Frostbite Risk Estimator";
const TOOL_SLUG = "wind-chill-calculator";
const TOOL_DESCRIPTION = "Compute feels-like wind chill index, skin convective heat loss rate, and frostbite onset windows.";
const TOOL_META_DESCRIPTION = "Calculate accurate feels-like wind chill temperatures, convective heat dissipation rates (W/m²), and time-to-frostbite under NOAA/NWS, Australian AT, and Siple standards.";
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="scrollbar-none mb-2 flex flex-wrap items-center gap-1 overflow-x-auto whitespace-nowrap text-xs text-slate-600 dark:text-slate-400 truncate">
              ...
              <span className="max-w-32.5 truncate font-medium text-slate-900 dark:text-white sm:max-w-50 md:max-w-none">
                Wind Chill &amp; Frostbite Estimator
              </span>
            </div>
