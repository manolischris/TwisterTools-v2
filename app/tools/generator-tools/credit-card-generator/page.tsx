...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Test Credit Card & Mock Identity Generator | TwisterTools",
    description:
      "Generate valid Luhn-checked test credit cards and complete mock identity profiles for gateway testing and sandbox environments.",
    url: "https://www.twistertools.com/tools/generator-tools/credit-card-generator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/generator-tools/credit-card-generator.jpg",
        width: 1200,
        height: 630,
        alt: "Test Credit Card & Mock Identity Generator on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Generate valid Luhn-checked test credit cards and complete mock identity profiles for gateway testing and sandbox environments.",
    images: [
      "https://www.twistertools.com/images/tools/generator-tools/credit-card-generator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/generator-tools/credit-card-generator",
  },
};

const CreditCardGeneratorPage: NextPage = () => {
  return (
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-3.5">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="scrollbar-none mb-1.5 flex flex-wrap items-center gap-1 overflow-x-auto whitespace-nowrap text-xs text-slate-500 dark:text-slate-400">
              ...
              <Link className="max-w-32.5 truncate font-medium transition-colors hover:text-indigo-600 dark:hover:text-indigo-400 sm:max-w-50 md:max-w-none" href="/tools/generator-tools">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/generator-tools/credit-card-generator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/generator-tools/credit-card-generator")}&text=${encodeURIComponent("Check out this free Test Credit Card & Mock Identity Generator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/generator-tools/credit-card-generator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
