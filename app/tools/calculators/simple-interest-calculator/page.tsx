...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Free browser-native simple interest and loan schedule calculator.",
    url: "https://www.twistertools.com/tools/calculators/simple-interest-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/simple-interest-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "Simple Interest & Loan Calculator on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Free browser-native simple interest and loan schedule calculator.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/simple-interest-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/simple-interest-calculator",
  },
};

const SimpleInterestCalculatorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-base text-slate-600 dark:text-slate-400 leading-snug">
                  Compute simple interest, total payback balances, and generate clear payment breakdowns instantly.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/simple-interest-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/simple-interest-calculator")}&text=${encodeURIComponent("Check out this free Simple Interest & Loan Calculator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/simple-interest-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <RelatedTools currentSlug="simple-interest-calculator" currentCategory="calculators" />
        </div>
      </div>
    </div>
  );
