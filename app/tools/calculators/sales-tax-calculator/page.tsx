...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Sales Tax Calculator & Gross/Net Expense Suite | TwisterTools",
    description:
      "Calculate sales tax, reverse extract net prices from gross totals, and log multi-line expenses with US state tax presets.",
    ...
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/sales-tax-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "Sales Tax Calculator & Gross/Net Expense Suite on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Calculate sales tax, reverse extract net prices from gross totals, and log multi-line expenses with US state tax presets.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/sales-tax-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/sales-tax-calculator",
  },
};

const SalesTaxCalculatorPage: NextPage = () => {
  return (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/sales-tax-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/sales-tax-calculator")}&text=${encodeURIComponent("Check out this free Sales Tax Calculator & Gross/Net Expense Suite tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/sales-tax-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
