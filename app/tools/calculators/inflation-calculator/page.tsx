...
export const metadata: Metadata = {
  title: "Inflation Rate & Purchasing Power Calculator | TwisterTools",
  description:
    "Calculate future money value, historical CPI erosion, purchasing power decay, and real investment returns with our browser-native monetary inflation calculator.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Calculate future money value, historical CPI erosion, purchasing power decay, and real investment returns with our browser-native monetary inflation calculator.",
    url: "https://www.twistertools.com/tools/calculators/inflation-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/inflation-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "Inflation Rate & Purchasing Power Calculator on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Calculate future money value, historical CPI erosion, purchasing power decay, and real investment returns with our browser-native monetary inflation calculator.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/inflation-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/inflation-calculator",
  },
};

const InflationCalculatorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/inflation-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/inflation-calculator")}&text=${encodeURIComponent("Calculate future money value, CPI decay, and real purchasing power erosion.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/inflation-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="inflation-calculator" currentCategory="calculators" />
        </div>
      </div>
    </div>
  );
