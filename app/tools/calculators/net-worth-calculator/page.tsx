...
export const metadata: Metadata = {
  title: "Net Worth & Personal Asset Calculator",
  description:
    "Calculate total wealth, track personal asset categories, and assess debt-to-asset leverage in real time.",
  keywords: [
  ...
  openGraph: {
    title: "Net Worth & Personal Asset Calculator | TwisterTools",
    description:
      "Calculate total wealth, track personal asset categories, and assess debt-to-asset leverage in real time.",
    url: "https://www.twistertools.com/tools/calculators/net-worth-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/net-worth-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "Net Worth & Personal Asset Calculator on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Calculate total wealth, track personal asset categories, and assess debt-to-asset leverage in real time.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/net-worth-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/net-worth-calculator",
  },
};

const NetWorthCalculatorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-lg sm:text-xl md:text-2xl font-extrabold tracking-tight leading-tight text-slate-900 dark:text-white">
                  Net Worth & Personal Asset Calculator
                </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/net-worth-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/net-worth-calculator")}&text=${encodeURIComponent("Calculate total wealth, track personal asset categories, and assess debt-to-asset leverage in real time.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/net-worth-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools
            currentSlug="net-worth-calculator"
