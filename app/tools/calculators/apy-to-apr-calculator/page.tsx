...
import ApyToAprCalculator from "@/components/tools/ApyToAprCalculator";
import RelatedTools from "@/components/RelatedTools";

const TOOL_TITLE = "APY to APR & Compound Yield Calculator";
const TOOL_SLUG = "apy-to-apr-calculator";
const TOOL_DESCRIPTION = "Convert APY to APR and APR to APY instantly across daily, monthly, and continuous compounding schedules with comprehensive compound interest yield modeling.";
...
const ApyToAprCalculatorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/apy-to-apr-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/apy-to-apr-calculator")}&text=${encodeURIComponent("Check out this free APY to APR & Compound Yield Calculator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/apy-to-apr-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <RelatedTools currentSlug="apy-to-apr-calculator" currentCategory="calculators" />
        </div>
      </div>
    </div>
  );
...
export default ApyToAprCalculatorPage;
