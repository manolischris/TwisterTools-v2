...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/compound-interest-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "Compound Interest & Growth Calculator on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Calculate interest compounding over time with monthly contributions, variable rates, APY modeling, and inflation adjustments.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/compound-interest-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/compound-interest-calculator",
  },
};
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/compound-interest-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/compound-interest-calculator")}&text=${encodeURIComponent("Check out this free Compound Interest & Growth Calculator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/compound-interest-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <RelatedTools currentSlug="compound-interest-calculator" currentCategory="calculators" />
        </div>
      </div>
    </div>
  );
