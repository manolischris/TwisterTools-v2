...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Calculate auto loan payments, trade-in tax credits, dealer fees, and amortization schedules.",
    url: "https://www.twistertools.com/tools/calculators/auto-loan-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/auto-loan-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "Auto Loan & Monthly Payment Estimator on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Calculate auto loan payments, trade-in tax credits, dealer fees, and amortization schedules.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/auto-loan-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/auto-loan-calculator",
  },
};
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/auto-loan-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/auto-loan-calculator")}&text=${encodeURIComponent("Check out this free Auto Loan & Monthly Payment Estimator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/auto-loan-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="auto-loan-calculator" currentCategory="calculators" />
        </div>
      </div>
    </div>
  );
