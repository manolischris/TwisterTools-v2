...
const TOOL_TITLE = "Down Payment Savings & Timeline Planner";
const TOOL_SLUG = "down-payment-calculator";
const TOOL_DESCRIPTION = "Calculate exact home down payment targets, projected monthly savings timelines, HYSA compound interest, closing costs, and mortgage readiness.";
...
const DownPaymentCalculatorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-1 text-xs text-slate-600 dark:text-slate-400 mb-2 truncate font-medium flex-wrap overflow-x-auto whitespace-nowrap scrollbar-none">
              ...
              <span className="text-slate-900 dark:text-white max-w-[130px] sm:max-w-[200px] md:max-w-none truncate">
                Down Payment Savings & Timeline Planner
              </span>
            </div>
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-10 h-10 sm:w-14 sm:h-14 p-1 sm:p-2 rounded-xl sm:rounded-2xl shrink-0 flex items-center justify-center bg-indigo-50/70 dark:bg-slate-800 shadow-sm">
                <Home className="w-7 h-7 sm:w-10 sm:h-10 text-indigo-600 dark:text-indigo-400" />
              </div>
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs sm:text-sm md:text-base text-slate-600 dark:text-slate-400 leading-relaxed line-clamp-2 sm:line-clamp-none">
                  Calculate exact home down payment targets, projected monthly savings timelines, HYSA compound interest, closing costs, and mortgage readiness.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/down-payment-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/down-payment-calculator")}&text=${encodeURIComponent("Calculate down payment targets, savings timelines, HYSA compound growth, and closing cost requirements.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/down-payment-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="down-payment-calculator" currentCategory="calculators" />
        </div>
      </div>
    </div>
  );
