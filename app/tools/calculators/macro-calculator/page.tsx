...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Calculate accurate protein, carb, and fat macro ratios for fat loss, lean muscle gain, or keto diets.",
    url: "https://www.twistertools.com/tools/calculators/macro-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/macro-calculator.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Calculate accurate protein, carb, and fat macro ratios for fat loss, lean muscle gain, or keto diets.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/macro-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/macro-calculator",
  },
};
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/macro-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/macro-calculator")}&text=${encodeURIComponent("Check out this free Macro Ratio & Flexible Dieting Calculator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/macro-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
