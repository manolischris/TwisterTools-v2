...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Calculate accurate Lean Body Mass (LBM), fat mass, Fat-Free Mass Index (FFMI), and Katch-McArdle BMR using clinical Boer, James, and Hume formulas.",
    url: "https://www.twistertools.com/tools/calculators/lean-body-mass-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/lean-body-mass-calculator.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Calculate accurate Lean Body Mass (LBM), fat mass, Fat-Free Mass Index (FFMI), and Katch-McArdle BMR using clinical Boer, James, and Hume formulas.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/lean-body-mass-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/lean-body-mass-calculator",
  },
};
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/lean-body-mass-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/lean-body-mass-calculator")}&text=${encodeURIComponent("Check out this free Lean Body Mass (LBM) Boer & James Formula Calculator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/lean-body-mass-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
