...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Probability Calculator & Event Odds Suite - TwisterTools",
    description:
      "Calculate single event odds, conditional joint probabilities, series repetitions, and binomial distribution PMF metrics.",
    url: "https://www.twistertools.com/tools/calculators/probability-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/probability-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "Probability Calculator & Event Odds Suite on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Calculate single event odds, conditional joint probabilities, series repetitions, and binomial distribution PMF metrics.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/probability-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/probability-calculator",
  },
};
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/probability-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/probability-calculator")}&text=${encodeURIComponent("Check out this free Probability Calculator & Event Odds Suite tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/probability-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
