...
export const metadata: Metadata = {
  ...
  description:
    "Convert annual salary to hourly rate and calculate net bi-weekly, monthly, and weekly take-home pay after taxes and deductions.",
  keywords: [
    "salary calculator",
    "hourly paycheck converter",
    "salary to hourly",
  ...
  openGraph: {
    title: "Salary & Hourly Paycheck Converter | TwisterTools",
    description:
      "Convert annual salary to hourly rate and calculate net bi-weekly, monthly, and weekly take-home pay after taxes and deductions.",
    url: "https://www.twistertools.com/tools/calculators/salary-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/salary-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "Salary & Hourly Paycheck Converter on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Convert annual salary to hourly rate and calculate net bi-weekly, monthly, and weekly take-home pay after taxes and deductions.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/salary-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/salary-calculator",
  },
};

const SalaryCalculatorPage: NextPage = () => {
  return (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/salary-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/salary-calculator")}&text=${encodeURIComponent("Convert annual salary to hourly rate and calculate net bi-weekly, monthly, and weekly take-home pay after taxes and deductions.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/salary-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
