...
export const metadata: Metadata = {
  ...
  description:
    "Calculate instant retail markdowns, stacked double discounts, post-tax subtotals, and reverse original list prices with precision.",
  keywords: [
    "discount calculator",
    "savings calculator",
    "markdown calculator",
    ...
    "retail calculator",
    "savings percentage",
    "stacked promo code calculator",
    "original price reconstruction",
    "twistertools",
  ],
  openGraph: {
    title: "Discount Calculator & Savings Percentage Suite | TwisterTools",
    description:
      "Calculate instant retail markdowns, stacked double discounts, post-tax subtotals, and reverse original list prices with precision.",
    ...
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/discount-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "Discount Calculator & Savings Percentage Suite on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Calculate instant retail markdowns, stacked double discounts, post-tax subtotals, and reverse original list prices with precision.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/discount-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/discount-calculator",
  },
};

const DiscountCalculatorPage: NextPage = () => {
  return (
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400 mb-1.5">
              ...
              <span className="text-slate-900 dark:text-white">
                Discount Calculator & Savings Suite
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/discount-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/discount-calculator")}&text=${encodeURIComponent("Check out this free Discount Calculator & Savings Suite tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/discount-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
