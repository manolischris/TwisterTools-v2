...
export const metadata: Metadata = {
  ...
  description:
    "Calculate long-term compound growth, monthly contributions, and investment returns.",
  keywords: [
  ...
  openGraph: {
    title: "Compound Investment & Return Calculator - TwisterTools",
    description:
      "Calculate long-term compound growth, monthly contributions, and investment returns.",
    url: "https://www.twistertools.com/tools/calculators/investment-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/investment-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "Compound Investment & Return Calculator on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Calculate long-term compound growth, monthly contributions, and investment returns.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/investment-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/investment-calculator",
  },
};

const InvestmentCalculatorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/investment-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/investment-calculator")}&text=${encodeURIComponent("Check out this free Compound Investment & Return Calculator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/investment-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <RelatedTools currentSlug="investment-calculator" currentCategory="calculators" />
        </div>
      </div>
    </div>
  );
