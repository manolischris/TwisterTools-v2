...
const TOOL_TITLE = "Credit Card Payoff Calculator";
const TOOL_SLUG = "credit-card-payoff-calculator";
const TOOL_DESCRIPTION = "Calculate exact credit card payoff dates, compare minimum payment costs against accelerated extra payment strategies, and save thousands in interest.";
...
const CreditCardPayoffCalculatorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/credit-card-payoff-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/credit-card-payoff-calculator")}&text=${encodeURIComponent("Check out this free Credit Card Payoff Calculator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/credit-card-payoff-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="credit-card-payoff-calculator" currentCategory="calculators" />
        </div>
      </div>
    </div>
  );
