...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Calculate personal target heart rate zones for fat loss, cardiovascular endurance, and athletic performance using Karvonen and Tanaka formulas.",
    url: "https://www.twistertools.com/tools/calculators/heart-rate-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/heart-rate-calculator.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Calculate personal target heart rate zones for fat loss, cardiovascular endurance, and athletic performance using Karvonen and Tanaka formulas.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/heart-rate-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/heart-rate-calculator",
  },
};
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/heart-rate-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/heart-rate-calculator")}&text=${encodeURIComponent("Check out this free Target Heart Rate Zone Calculator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/heart-rate-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
