...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "AdSense Revenue & CTR/RPM Earnings Calculator - TwisterTools",
    description:
      "Estimate monthly Google AdSense earnings, click-through rates, and page RPM.",
    url: "https://www.twistertools.com/tools/calculators/adsense-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/adsense-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "AdSense Revenue & CTR/RPM Earnings Calculator on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Estimate monthly Google AdSense earnings, click-through rates, and page RPM.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/adsense-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/adsense-calculator",
  },
};

const AdSenseCalculatorPage: NextPage = () => {
  return (
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-10 h-10 sm:w-14 sm:h-14 p-1 sm:p-2 rounded-xl sm:rounded-2xl shrink-0 flex items-center justify-center bg-indigo-50/70 dark:bg-slate-800 shadow-sm">
                <DollarSign className="w-7 h-7 sm:w-10 sm:h-10 text-indigo-600 dark:text-indigo-400" />
              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/adsense-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/adsense-calculator")}&text=${encodeURIComponent("Check out this free AdSense Revenue Calculator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/adsense-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
...
export default AdSenseCalculatorPage;
