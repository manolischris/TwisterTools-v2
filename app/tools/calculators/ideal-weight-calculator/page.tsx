...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Calculate clinical ideal body weight using Devine, Robinson, Miller, and Hamwi formulas with healthy BMI ranges.",
    url: "https://www.twistertools.com/tools/calculators/ideal-weight-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/ideal-weight-calculator.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Calculate clinical ideal body weight using Devine, Robinson, Miller, and Hamwi formulas with healthy BMI ranges.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/ideal-weight-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/ideal-weight-calculator",
  },
};
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/ideal-weight-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/ideal-weight-calculator")}&text=${encodeURIComponent("Check out this free Ideal Body Weight (IBW) Calculator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/ideal-weight-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
