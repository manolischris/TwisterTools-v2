...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Convert daily pedometer step counts into exact miles, kilometers, active walking duration, and burned calories using MET bio-energetics and dynamic stride calculation.",
    url: "https://www.twistertools.com/tools/calculators/steps-to-calories-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/steps-to-calories-calculator.webp",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Convert daily pedometer step counts into exact miles, kilometers, active walking duration, and burned calories using MET bio-energetics and dynamic stride calculation.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/steps-to-calories-calculator.webp",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/steps-to-calories-calculator",
  },
};
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/steps-to-calories-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/steps-to-calories-calculator")}&text=${encodeURIComponent("Check out this free Daily Steps to Distance, Miles & Calories Converter tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/steps-to-calories-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
