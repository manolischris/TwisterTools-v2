...
const TOOL_TITLE = "Refinance Break-Even & Interest Savings Calculator";
const TOOL_SLUG = "mortgage-refinance-calculator";
const TOOL_DESCRIPTION = "Calculate your mortgage refinance break-even point in months, compare monthly payment reductions, and evaluate lifetime interest savings.";
...
const MortgageRefinanceCalculatorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-gradient-to-r from-indigo-50/80 via-white to-slate-50/50 dark:from-slate-900/50 dark:via-slate-950 dark:to-slate-900/50 border-b border-slate-200 dark:border-slate-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-3 sm:py-3.5 md:py-4">
          <div className="max-w-6xl mx-auto">
            {/* Breadcrumb */}
            <div className="flex items-center gap-1 text-xs text-slate-600 dark:text-slate-400 mb-2 truncate flex-wrap overflow-x-auto whitespace-nowrap scrollbar-none font-medium">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-lg sm:text-xl md:text-2xl font-extrabold tracking-tight leading-tight text-slate-900 dark:text-white">
                  Refinance Break-Even & Interest Savings Calculator
                </h1>
                <p className="text-xs sm:text-sm md:text-base text-slate-600 dark:text-slate-400 leading-relaxed line-clamp-2 sm:line-clamp-none">
                  Calculate your mortgage refinance break-even point in months, compare monthly payment reductions, and evaluate lifetime interest savings.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/mortgage-refinance-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/mortgage-refinance-calculator")}&text=${encodeURIComponent("Check out this free Refinance Break-Even & Interest Savings Calculator!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/mortgage-refinance-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="mortgage-refinance-calculator" currentCategory="calculators" />
        </div>
      </div>
    </div>
  );
