...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Calculate restaurant tips, sales tax, and group bill splits with itemized individual breakdowns.",
    url: "https://www.twistertools.com/tools/calculators/tip-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/tip-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "Tip & Bill Splitter Calculator on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Calculate restaurant tips, sales tax, and group bill splits with itemized individual breakdowns.",
    images: [
      "https://www.twistertools.com/images/tools/calculators/tip-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/tip-calculator",
  },
};

const TipCalculatorPage: NextPage = () => {
  return (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/tip-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/tip-calculator")}&text=${encodeURIComponent("Calculate restaurant tips, sales tax, and group bill splits with itemized individual breakdowns.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/tip-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
