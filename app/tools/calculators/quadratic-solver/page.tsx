...
export async function generateMetadata(): Promise<Metadata> {
  const canonicalUrl = "https://www.twistertools.com/tools/calculators/quadratic-solver";
  ...
  const ogImageUrl = fs.existsSync(webpPath)
    ? "https://www.twistertools.com/images/tools/calculators/quadratic-solver.webp"
    : fs.existsSync(jpgPath)
      ? "https://www.twistertools.com/images/tools/calculators/quadratic-solver.jpg"
