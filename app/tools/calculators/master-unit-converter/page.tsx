...
export const metadata: Metadata = {
  ...
  description:
    "High-precision unit conversion across 11 physical & engineering domains (Length, Mass, Pressure, Temp, Torque & more).",
  keywords: [
    "unit converter",
    "unit conversion",
    "length converter",
  ...
  openGraph: {
    title: "Universal Unit Converter Suite | TwisterTools",
    description:
      "High-precision unit conversion across 11 physical & engineering domains (Length, Mass, Pressure, Temp, Torque & more).",
    url: "https://www.twistertools.com/tools/calculators/master-unit-converter",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/calculators/master-unit-converter.jpg",
        width: 1200,
        height: 630,
        alt: "Universal Unit Converter Suite on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "High-precision unit conversion across 11 physical & engineering domains (Length, Mass, Pressure, Temp, Torque & more).",
    images: [
      "https://www.twistertools.com/images/tools/calculators/master-unit-converter.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/calculators/master-unit-converter",
  },
};

const MasterUnitConverterPage: NextPage = () => {
  return (
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-1 text-sm text-slate-600 dark:text-slate-400 mb-1.5 flex-wrap overflow-x-auto whitespace-nowrap scrollbar-none">
              ...
              <span className="text-slate-900 dark:text-white max-w-[130px] sm:max-w-[200px] md:max-w-none truncate">
                Universal Unit Converter Suite
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/calculators/master-unit-converter")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/master-unit-converter")}&text=${encodeURIComponent("Check out this free Universal Unit Converter Suite tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/calculators/master-unit-converter")}`}
                    target="_blank"
                    rel="noopener noreferrer"
...
export default MasterUnitConverterPage;