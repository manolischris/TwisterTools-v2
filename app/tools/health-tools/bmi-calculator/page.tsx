...
export const metadata: Metadata = {
  ...
  description:
    "Calculate BMI, ideal weight targets, estimated body fat %, BMR, and TDEE.",
  keywords: [
    "bmi calculator",
    "body mass index",
  ...
  openGraph: {
    title: "BMI & Body Composition Calculator | TwisterTools",
    description:
      "Calculate BMI, ideal weight targets, estimated body fat %, BMR, and TDEE.",
    url: "https://www.twistertools.com/tools/health-tools/bmi-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/health-tools/bmi-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "BMI & Body Composition Calculator on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Calculate BMI, ideal weight targets, estimated body fat %, BMR, and TDEE.",
    images: [
      "https://www.twistertools.com/images/tools/health-tools/bmi-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/health-tools/bmi-calculator",
  },
};
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/bmi-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/bmi-calculator")}&text=${encodeURIComponent("Check out this free BMI & Body Composition Calculator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/bmi-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
