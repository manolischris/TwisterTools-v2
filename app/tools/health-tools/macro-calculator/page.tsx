...
export const metadata: Metadata = {
  ...
  description:
    "Calculate accurate protein, carb, and fat macro ratios for fat loss, lean muscle gain, or keto diets.",
  keywords: [
    "macro calculator",
  ...
  openGraph: {
    title: "Macro Ratio & Flexible Dieting Calculator | TwisterTools",
    description:
      "Calculate accurate protein, carb, and fat macro ratios for fat loss, lean muscle gain, or keto diets.",
    url: "https://www.twistertools.com/tools/health-tools/macro-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/health-tools/macro-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "Macro Ratio & Flexible Dieting Calculator on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Calculate accurate protein, carb, and fat macro ratios for fat loss, lean muscle gain, or keto diets.",
    images: [
      "https://www.twistertools.com/images/tools/health-tools/macro-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/health-tools/macro-calculator",
  },
};

const MacroCalculatorPage: NextPage = () => {
  return (
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-10 h-10 sm:w-14 sm:h-14 p-1 sm:p-2 rounded-xl sm:rounded-2xl shrink-0 flex items-center justify-center bg-indigo-50/70 dark:bg-slate-800 shadow-sm">
                <PieChart className="w-7 h-7 sm:w-10 sm:h-10 text-indigo-600 dark:text-indigo-400 fill-indigo-100 dark:fill-indigo-950" />
              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/macro-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/macro-calculator")}&text=${encodeURIComponent("Check out this free Macro Ratio & Flexible Dieting Calculator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/macro-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
