...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Ideal Body Weight (IBW) Calculator | TwisterTools",
    description:
      "Calculate clinical ideal body weight using Devine, Robinson, Miller, and Hamwi formulas with healthy BMI ranges.",
    url: "https://www.twistertools.com/tools/health-tools/ideal-weight-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/health-tools/ideal-weight-calculator.jpg",
        width: 1200,
        height: 630,
        alt: "Ideal Body Weight (IBW) Calculator on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Calculate clinical ideal body weight using Devine, Robinson, Miller, and Hamwi formulas with healthy BMI ranges.",
    images: [
      "https://www.twistertools.com/images/tools/health-tools/ideal-weight-calculator.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/health-tools/ideal-weight-calculator",
  },
};

const IdealWeightCalculatorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/ideal-weight-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/ideal-weight-calculator")}&text=${encodeURIComponent("Check out this free Ideal Body Weight (IBW) Calculator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/ideal-weight-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools
            currentSlug="ideal-weight-calculator"
