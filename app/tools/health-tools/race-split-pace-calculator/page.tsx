...
import RaceSplitPaceCalculator from "@/components/tools/RaceSplitPaceCalculator";
import RelatedTools from "@/components/RelatedTools";

const TOOL_TITLE = "Running Split Times & Race Finish Pace Estimator";
const TOOL_SLUG = "race-split-pace-calculator";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Race Split Times & Finish Pace Estimator",
    ...
    openGraph: {
      title: "Race Split Times & Finish Pace Estimator | TwisterTools",
      description: TOOL_DESCRIPTION,
      url: canonicalUrl,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Race Split Times & Finish Pace Estimator on TwisterTools",
        },
      ],
    },
    twitter: {
...
const RaceSplitPaceCalculatorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-1 text-xs text-slate-600 dark:text-slate-400 mb-2 truncate font-medium flex-wrap overflow-x-auto whitespace-nowrap scrollbar-none">
              ...
              <span className="text-slate-900 dark:text-white max-w-[130px] sm:max-w-[200px] md:max-w-none truncate">
                Running Split Times & Race Finish Pace Estimator
              </span>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/race-split-pace-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/race-split-pace-calculator")}&text=${encodeURIComponent("Calculate race split milestones, negative split pacing, marathon projections, and heart rate training zones.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/race-split-pace-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="race-split-pace-calculator" currentCategory="health-tools" />
        </div>
      </div>
    </div>
  );
...
export default RaceSplitPaceCalculatorPage;
