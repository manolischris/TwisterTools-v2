...
import IntermittentFastingCalculator from "@/components/tools/IntermittentFastingCalculator";
import RelatedTools from "@/components/RelatedTools";
import fs from "node:fs";
import path from "node:path";

const TOOL_TITLE = "Intermittent Fasting Window & Meal Schedule Tracker";
const TOOL_SLUG = "intermittent-fasting-calculator";
const TOOL_DESCRIPTION = "Calculate custom fasting and eating windows, meal distribution timing, hydration goals, and metabolic autophagy stages across 16:8, 18:6, 20:4, and OMAD protocols.";
...
const IntermittentFastingCalculatorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-1 text-sm text-slate-600 dark:text-slate-400 mb-1.5 flex-wrap overflow-x-auto whitespace-nowrap scrollbar-none">
              ...
              <span className="text-slate-900 dark:text-white font-medium max-w-[130px] sm:max-w-[200px] md:max-w-none truncate">
                Intermittent Fasting Window &amp; Meal Schedule Tracker
              </span>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-base text-slate-600 dark:text-slate-400 leading-snug">
                  Calculate custom fasting and eating windows, meal distribution timing, hydration goals, and metabolic autophagy stages across 16:8, 18:6, 20:4, and OMAD protocols.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/intermittent-fasting-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/intermittent-fasting-calculator")}&text=${encodeURIComponent("Check out this free Intermittent Fasting Calculator & Meal Tracker tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/intermittent-fasting-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools
            currentSlug="intermittent-fasting-calculator"
