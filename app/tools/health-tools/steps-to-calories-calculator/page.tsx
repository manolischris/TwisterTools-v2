...
import StepsToCaloriesCalculator from "@/components/tools/StepsToCaloriesCalculator";
import RelatedTools from "@/components/RelatedTools";

export const metadata: Metadata = {
  title: "Daily Steps to Distance, Miles & Calories Converter",
  description:
    "Convert daily pedometer step counts into exact miles, kilometers, active walking duration, and burned calories using MET bio-energetics and dynamic stride calculation.",
  keywords: [
    "steps to calories",
    "steps to miles",
    "steps to km",
  ...
  openGraph: {
    title: "Daily Steps to Distance, Miles & Calories Converter | TwisterTools",
    description:
      "Convert daily pedometer step counts into exact miles, kilometers, active walking duration, and burned calories using MET bio-energetics and dynamic stride calculation.",
    url: "https://www.twistertools.com/tools/health-tools/steps-to-calories-calculator",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/health-tools/steps-to-calories-calculator.webp",
        width: 1200,
        height: 630,
        alt: "Daily Steps to Distance, Miles & Calories Converter on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Convert daily pedometer step counts into exact miles, kilometers, active walking duration, and burned calories using MET bio-energetics and dynamic stride calculation.",
    images: [
      "https://www.twistertools.com/images/tools/health-tools/steps-to-calories-calculator.webp",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/health-tools/steps-to-calories-calculator",
  },
};

const StepsToCaloriesCalculatorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-1 text-sm text-slate-600 dark:text-slate-400 mb-1.5 flex-wrap overflow-x-auto whitespace-nowrap scrollbar-none">
              ...
              <span className="text-slate-900 dark:text-white max-w-[130px] sm:max-w-[200px] md:max-w-none truncate">
                Daily Steps to Distance, Miles & Calories Converter
              </span>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-base text-slate-600 dark:text-slate-400 leading-snug">
                  Convert daily pedometer steps into miles, kilometers, active duration, and calories burned.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/steps-to-calories-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/steps-to-calories-calculator")}&text=${encodeURIComponent("Check out this free Daily Steps to Distance, Miles & Calories Converter tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/steps-to-calories-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools
            currentSlug="steps-to-calories-calculator"
...
export default StepsToCaloriesCalculatorPage;
