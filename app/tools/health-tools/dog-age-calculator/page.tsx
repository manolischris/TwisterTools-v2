...
const TOOL_TITLE = "Dog Age to Human Years Biological Converter";
const TOOL_SLUG = "dog-age-calculator";
const TOOL_DESCRIPTION =
  "Convert dog age to human years using UC San Diego Epigenetic DNA methylation formulas, AVMA veterinary size-adjusted metrics, and canine life stage analytics.";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...
      "canine biological age",
      "epigenetic dog age",
      "AVMA dog age formula",
      "UC San Diego DNA methylation",
...
const DogAgeCalculatorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-1 text-xs text-slate-600 dark:text-slate-400 mb-2 truncate flex-wrap overflow-x-auto whitespace-nowrap scrollbar-none">
              ...
              <span className="text-slate-900 dark:text-white font-medium max-w-[130px] sm:max-w-[200px] md:max-w-none truncate">
                Dog Age to Human Years Biological Converter
              </span>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/dog-age-calculator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/dog-age-calculator")}&text=${encodeURIComponent("Check out this free Dog Age to Human Years Biological Converter!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/health-tools/dog-age-calculator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools
            currentSlug="dog-age-calculator"
...
export default DogAgeCalculatorPage;
