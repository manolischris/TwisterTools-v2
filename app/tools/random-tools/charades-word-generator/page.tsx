...
import CharadesWordGenerator from "@/components/tools/CharadesWordGenerator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Charades & Game Night Word Generator";
const TOOL_SLUG = "charades-word-generator";
const TOOL_DESCRIPTION =
  "Generate instant random prompt cards for acting, sketching, and party games with countdown timers and live team scoring.";
const TOOL_META_DESCRIPTION =
  "Generate instant random ideas for Charades, sketch games, and party game night. Features tiered difficulty levels, round timer buzzer, team scoring, hints, and custom decks.";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...
      "pictionary prompts",
      "charades ideas",
      "game night word generator",
      "catchphrase words",
      "random charades generator",
      "pictionary word generator",
      "team game timer",
      "charades hint generator",
      "random tools",
      "twistertools"
    ],
    alternates: {
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-indigo-200/80 bg-gradient-to-br from-indigo-50 to-white p-1 shadow-xs shadow-indigo-100/60 dark:border-indigo-900/50 dark:from-slate-800 dark:to-slate-900 sm:h-14 sm:w-14 sm:rounded-2xl sm:p-2">
                <Gamepad2 className="h-6 w-6 text-indigo-600 dark:text-indigo-400 sm:h-9 sm:w-9" />
              </div>
