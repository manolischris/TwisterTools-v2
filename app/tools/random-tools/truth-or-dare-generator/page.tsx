...
import TruthOrDareGenerator from "@/components/tools/TruthOrDareGenerator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Truth or Dare Card Prompt Generator";
const TOOL_SLUG = "truth-or-dare-generator";
...
const TOOL_META_DESCRIPTION =
  "Free online Truth or Dare card generator. Draw cryptographically random prompt cards across 5 curated game modes, inject your own custom deck, and track player turns and scores — 100% in your browser.";
