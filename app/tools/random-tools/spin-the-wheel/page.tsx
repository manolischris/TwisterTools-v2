...
const TOOL_TITLE = "Spin the Wheel & Choice Picker";
const TOOL_SLUG = "spin-the-wheel";
...
const TOOL_META_DESCRIPTION =
  "Free online Spin the Wheel choice picker. Make fair random decisions, pick contest winners, and execute weighted probability drawings with Web Crypto RNG.";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: "Spin the Wheel & Choice Picker | TwisterTools",
      description: TOOL_META_DESCRIPTION,
      url: canonicalUrl,
