...
import RandomTimeGenerator from "@/components/tools/RandomTimeGenerator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Random Time & Hour Generator";
const TOOL_SLUG = "random-time-generator";
...
const TOOL_META_DESCRIPTION =
  "Generate cryptographically secure random times, clock hours, and timestamps within custom intervals, timezones, and discrete step intervals — 100% client-side.";
...
export default function RandomTimeGeneratorPage() {
