...
import SecretSantaGenerator from "@/components/tools/SecretSantaGenerator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Secret Santa & Holiday Gift Exchange Matcher";
const TOOL_SLUG = "secret-santa-generator";
...
const TOOL_META_DESCRIPTION =
  "Free online Secret Santa generator. Create unbiased gift exchange pairings with custom exclusion rules, budget caps, wishlists, and private invitation cards — 100% client-side.";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: "Secret Santa & Holiday Gift Exchange Matcher | TwisterTools",
      description: TOOL_META_DESCRIPTION,
      url: canonicalUrl,
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-indigo-200/80 bg-gradient-to-br from-indigo-50 to-white p-1 shadow-xs shadow-indigo-100/60 dark:border-indigo-900/50 dark:from-slate-800 dark:to-slate-900 sm:h-14 sm:w-14 sm:rounded-2xl sm:p-2">
                <Gift className="h-6 w-6 text-indigo-600 dark:text-indigo-400 sm:h-9 sm:w-9" />
              </div>
