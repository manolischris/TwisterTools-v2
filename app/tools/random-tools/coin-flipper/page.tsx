...
import CoinFlipper from "@/components/tools/CoinFlipper";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Coin Flipper & Probability Simulator";
const TOOL_SLUG = "coin-flipper";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: "Coin Flipper & Probability Simulator | TwisterTools",
      description: TOOL_META_DESCRIPTION,
      url: canonicalUrl,
