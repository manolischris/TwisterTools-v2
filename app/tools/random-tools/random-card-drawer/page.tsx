...
import RandomCardDrawer from "@/components/tools/RandomCardDrawer";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Playing Card Shuffler & Hand Generator";
const TOOL_SLUG = "random-card-drawer";
...
export default function RandomCardDrawerPage() {
