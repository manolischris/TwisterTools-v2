...
const TOOL_TITLE = "Random Name Picker & Winner Selector";
const TOOL_SLUG = "random-name-picker";
const TOOL_DESCRIPTION =
  "Pick random winners securely with Web Crypto API entropy and slot-machine animations.";
const TOOL_META_DESCRIPTION =
  "Enterprise-grade browser-native random name picker and winner selector. Features cryptographic Web Crypto API entropy, customizable sampling, slot-machine animations, and CSV export.";
