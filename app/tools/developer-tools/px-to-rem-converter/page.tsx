...
const TOOL_TITLE = "Pixels to REM / EM Converter";
const TOOL_SLUG = "px-to-rem-converter";
const TOOL_DESCRIPTION = "Convert Pixels (px) to REM, EM, Percentages, and Tailwind CSS spacing units in real time with batch stylesheet parsing.";
...
const PxToRemConverterPage: NextPage = () => {
  return (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/px-to-rem-converter")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/px-to-rem-converter")}&text=${encodeURIComponent("Check out this free Pixels to REM / EM Converter tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/px-to-rem-converter")}`}
                    target="_blank"
                    rel="noopener noreferrer"
