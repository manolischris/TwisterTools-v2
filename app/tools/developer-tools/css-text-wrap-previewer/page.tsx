...
import CssTextWrapPreviewer from "@/components/tools/CssTextWrapPreviewer";
import RelatedTools from "@/components/RelatedTools";

const TOOL_TITLE = "CSS text-wrap: balance & pretty Previewer";
const TOOL_SLUG = "css-text-wrap-previewer";
...
export async function generateMetadata(): Promise<Metadata> {
  const canonicalUrl = `https://twistertools.com/tools/developer-tools/${TOOL_SLUG}`;
  ...
  const ogImageUrl = fs.existsSync(webpPath)
    ? `https://twistertools.com/images/tools/developer-tools/${TOOL_SLUG}.webp`
    : fs.existsSync(jpgPath)
      ? `https://twistertools.com/images/tools/developer-tools/${TOOL_SLUG}.jpg`
      : "https://twistertools.com/images/og-default.jpg";
  ...
  return {
    ...
    keywords: [
      ...
      "text-wrap balance",
      "text-wrap pretty",
      "css typography previewer",
      "prevent orphan words",
      "widow elimination css",
      "developer tools",
      "twistertools"
    ],
    alternates: {
    ...
    openGraph: {
      title: "CSS text-wrap: balance & pretty Previewer | TwisterTools",
      description: TOOL_DESCRIPTION,
      url: canonicalUrl,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "CSS text-wrap: balance & pretty Previewer on TwisterTools",
        },
      ],
    },
    twitter: {
...
const CssTextWrapPreviewerPage: NextPage = () => {
  return (
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-3.5">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="scrollbar-none mb-1.5 flex flex-wrap items-center gap-1 overflow-x-auto whitespace-nowrap text-xs text-slate-500 dark:text-slate-400">
              ...
              <Link className="max-w-32.5 truncate font-medium transition-colors hover:text-indigo-600 dark:hover:text-indigo-400 sm:max-w-50 md:max-w-none" href="/tools/developer-tools">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-indigo-200/80 bg-gradient-to-br from-indigo-50 to-white p-1 shadow-xs shadow-indigo-100/60 dark:border-indigo-900/50 dark:from-slate-800 dark:to-slate-900 sm:h-14 sm:w-14 sm:rounded-2xl sm:p-2">
                <AlignJustify className="h-6 w-6 text-indigo-600 dark:text-indigo-400 sm:h-9 sm:w-9" />
              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://twistertools.com/tools/developer-tools/${TOOL_SLUG}`)}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(`https://twistertools.com/tools/developer-tools/${TOOL_SLUG}`)}&text=${encodeURIComponent("Check out this CSS text-wrap balance & pretty previewer tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://twistertools.com/tools/developer-tools/${TOOL_SLUG}`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
...
export default CssTextWrapPreviewerPage;
