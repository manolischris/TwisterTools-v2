...
const TOOL_TITLE = "JSON Schema Generator from Mock JSON Data";
const TOOL_SLUG = "json-to-json-schema";
...
const JsonToJsonSchemaPage: NextPage = () => {
  return (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/json-to-json-schema")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/json-to-json-schema")}&text=${encodeURIComponent("Check out this free JSON Schema Generator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/json-to-json-schema")}`}
                    target="_blank"
                    rel="noopener noreferrer"
