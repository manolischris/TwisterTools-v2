...
const TOOL_TITLE = "CSS Gradient Generator & Code Exporter";
const TOOL_SLUG = "css-gradient-generator";
const TOOL_DESCRIPTION = "Design and export beautiful CSS linear, radial, and conic gradients with vendor prefixes and Tailwind CSS code.";
...
const CssGradientGeneratorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/css-gradient-generator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/css-gradient-generator")}&text=${encodeURIComponent("Check out this free CSS Gradient Generator & Code Exporter tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/css-gradient-generator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="css-gradient-generator" currentCategory="developer-tools" />
        </div>
      </div>
    </div>
  );
