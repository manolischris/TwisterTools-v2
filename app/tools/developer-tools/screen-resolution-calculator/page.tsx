...
import ScreenResolutionCalculator from "@/components/tools/ScreenResolutionCalculator";
import RelatedTools from "@/components/RelatedTools";

const TOOL_TITLE = "Screen Resolution & Aspect Ratio Calculator";
const TOOL_SLUG = "screen-resolution-calculator";
const TOOL_DESCRIPTION = "Calculate display resolutions, aspect ratios, proportional scaling dimensions, PPI pixel density, and CSS aspect-ratio code snippets.";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: "Screen Resolution & Aspect Ratio Calculator | TwisterTools",
      description: TOOL_DESCRIPTION,
      url: canonicalUrl,
...
const ScreenResolutionCalculatorPage: NextPage = () => {
  return (
          ...
          <div className="bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(`https://www.twistertools.com/tools/developer-tools/${TOOL_SLUG}`)}&text=${encodeURIComponent(`Check out this free ${TOOL_TITLE} tool!`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
...
export default ScreenResolutionCalculatorPage;
