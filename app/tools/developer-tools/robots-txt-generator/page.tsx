...
const TOOL_TITLE = "Robots.txt Code Generator & Validator";
const TOOL_SLUG = "robots-txt-generator";
const TOOL_DESCRIPTION = "Generate RFC 9309 compliant robots.txt files with visual user-agent controls, AI scraper blocking presets, XML sitemap directives, and real-time crawl path validation.";
...
const RobotsTxtGeneratorPage: NextPage = () => {
  return (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/robots-txt-generator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/robots-txt-generator")}&text=${encodeURIComponent("Check out this free Robots.txt Code Generator & Validator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/robots-txt-generator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
