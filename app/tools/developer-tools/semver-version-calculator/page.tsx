...
import SemverVersionCalculator from "@/components/tools/SemverVersionCalculator";
import RelatedTools from "@/components/RelatedTools";

const TOOL_TITLE = "SemVer Semantic Version Comparison & Bump Calculator";
const TOOL_SLUG = "semver-version-calculator";
...
const SemverVersionCalculatorPage: NextPage = () => {
  return (
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-indigo-200/80 bg-gradient-to-br from-indigo-50 to-white p-1 shadow-xs shadow-indigo-100/60 dark:border-indigo-900/50 dark:from-slate-800 dark:to-slate-900 sm:h-14 sm:w-14 sm:rounded-2xl sm:p-2">
                <GitCompare className="h-6 w-6 text-indigo-600 dark:text-indigo-400 sm:h-9 sm:w-9" />
              </div>
          ...
          <div className="bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(`https://www.twistertools.com/tools/developer-tools/${TOOL_SLUG}`)}&text=${encodeURIComponent("Check out this SemVer Version Calculator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
...
export default SemverVersionCalculatorPage;
