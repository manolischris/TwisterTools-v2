...
const TOOL_TITLE = "CSS Triangle & Polygon Generator";
const TOOL_SLUG = "css-triangle-generator";
...
export default function CssTriangleGeneratorPage() {
  const toolUrl = `https://www.twistertools.com/tools/developer-tools/${TOOL_SLUG}`;
