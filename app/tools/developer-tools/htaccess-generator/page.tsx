...
const TOOL_TITLE = "HTACCESS Directives & Rewrite Rules Generator";
const TOOL_SLUG = "htaccess-generator";
const TOOL_DESCRIPTION = "Generate production-ready Apache .htaccess rules with 301 redirects, HTTPS enforcement, GZIP, and security headers.";
...
const HtaccessGeneratorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/htaccess-generator")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/htaccess-generator")}&text=${encodeURIComponent("Check out this free HTACCESS Directives & Rewrite Rules Generator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/htaccess-generator")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="htaccess-generator" currentCategory="developer-tools" />
        </div>
      </div>
    </div>
  );
