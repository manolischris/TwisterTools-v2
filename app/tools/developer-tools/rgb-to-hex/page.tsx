...
export const metadata: Metadata = {
  ...
  description:
    "Convert colors seamlessly between Hex, RGB, RGBA, HSL, and CMYK formats with real-time sliders and WCAG contrast checks.",
  keywords: [
    "RGB to Hex",
    "Hex to RGB",
    "color converter",
  ...
  openGraph: {
    title: "RGB to Hex & Hex to RGB Color Converter | TwisterTools",
    description:
      "Convert colors seamlessly between Hex, RGB, RGBA, HSL, and CMYK formats with real-time sliders and WCAG contrast checks.",
    ...
    images: [
      {
        url: "https://www.twistertools.com/images/tools/developer-tools/rgb-to-hex.jpg",
        width: 1200,
        height: 630,
        alt: "RGB to Hex & Hex to RGB Color Converter on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Convert colors seamlessly between Hex, RGB, RGBA, HSL, and CMYK formats with real-time sliders and WCAG contrast checks.",
    images: [
      "https://www.twistertools.com/images/tools/developer-tools/rgb-to-hex.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/developer-tools/rgb-to-hex",
  },
};

const RgbToHexPage: NextPage = () => {
  return (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/rgb-to-hex")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/rgb-to-hex")}&text=${encodeURIComponent("Check out this free RGB to Hex & Hex to RGB Color Converter tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/developer-tools/rgb-to-hex")}`}
                    target="_blank"
                    rel="noopener noreferrer"
