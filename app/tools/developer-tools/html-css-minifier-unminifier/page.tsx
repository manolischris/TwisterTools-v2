...
export async function generateMetadata() {
  ...
  const ogImageUrl = imageExists
    ? "https://www.twistertools.com/images/tools/developer-tools/html-css-minifier-unminifier.jpg"
  ...
  return {
    ...
    openGraph: {
      title: "HTML & CSS Minifier & Unminifier",
      description: "Free online HTML and CSS minifier and unminifier. Minify, unminify, compress, and beautify HTML markup and CSS stylesheets instantly with pure client-side processing.",
      url: pageUrl,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "HTML & CSS Minifier & Unminifier on TwisterTools",
        },
      ],
    },
    twitter: {
      card: "summary_large_image",
      title: "HTML & CSS Minifier & Unminifier | TwisterTools",
      description: "Free online HTML and CSS minifier and unminifier. Minify, unminify, compress, and beautify HTML markup and CSS stylesheets instantly with pure client-side processing.",
      images: [ogImageUrl],
    },
    alternates: {
...
export default function HtmlCssMinifierPage() {
  const toolUrl = "https://www.twistertools.com/tools/developer-tools/html-css-minifier-unminifier";
          ...
          <div className="bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free HTML & CSS Minifier & Unminifier tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
