...
import CssContainerQueryBuilder from "@/components/tools/CssContainerQueryBuilder";
import RelatedTools from "@/components/RelatedTools";

const TOOL_TITLE = "CSS Container Query (CQ) & Size-Container Formatter";
const TOOL_SLUG = "css-container-query-builder";
...
const CssContainerQueryBuilderPage: NextPage = () => {
  return (
          ...
          <div className="bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(`https://www.twistertools.com/tools/developer-tools/${TOOL_SLUG}`)}&text=${encodeURIComponent("Check out this CSS Container Query (CQ) & Size-Container Formatter tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
...
export default CssContainerQueryBuilderPage;
