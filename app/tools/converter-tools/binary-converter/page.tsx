...
import { Binary, Copy, Check, QrCode } from "lucide-react";
...
export async function generateMetadata() {
  ...
  return {
    title: "Unified Binary & Number Base Converter",
    description: "Free online unified binary and number base converter. Convert between text, binary, ASCII, decimal, octal, and hexadecimal bases instantly.",
    keywords: ["binary converter", "base converter", "hex converter", "ascii converter", "decimal converter", "octal converter", "twistertools"],
    openGraph: {
      title: "Unified Binary & Number Base Converter",
      description: "Free online unified binary and number base converter. Convert between text, binary, ASCII, decimal, octal, and hexadecimal bases instantly.",
      url: pageUrl,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Unified Binary & Number Base Converter on TwisterTools",
        },
      ],
    },
    twitter: {
      card: "summary_large_image",
      title: "Unified Binary & Number Base Converter | TwisterTools",
      description: "Free online unified binary and number base converter. Convert between text, binary, ASCII, decimal, octal, and hexadecimal bases instantly.",
      images: [ogImageUrl],
    },
    alternates: {
...
export default function BinaryConverterPage() {
  const toolUrl = "https://www.twistertools.com/tools/converter-tools/binary-converter";
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-3.5">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="scrollbar-none mb-1.5 flex flex-wrap items-center gap-1 overflow-x-auto whitespace-nowrap text-xs text-slate-500 dark:text-slate-400">
              ...
              <Link className="max-w-32.5 truncate font-medium transition-colors hover:text-indigo-600 dark:hover:text-indigo-400 sm:max-w-50 md:max-w-none" href="/tools/converter-tools">
              ...
              <span className="max-w-32.5 truncate font-semibold text-slate-800 dark:text-slate-200 sm:max-w-50 md:max-w-none">
                Unified Binary &amp; Number Base Converter
              </span>
            </div>
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="line-clamp-2 text-xs leading-relaxed text-slate-700 dark:text-slate-300 sm:line-clamp-none sm:text-sm md:text-base">
                  Convert text, ASCII, decimal, octal, and hexadecimal values dynamically.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free Unified Binary & Number Base Converter tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
