...
const TOOL_TITLE = "Social Media Character & Byte Limit Counter";
const TOOL_SLUG = "social-character-counter";
...
const TOOL_META_TITLE =
  "Social Media Character & Byte Limit Counter (X, IG, LinkedIn)";
const TOOL_META_DESCRIPTION =
  "Audit post character lengths, Twitter weighted characters, UTF-8 byte payloads, and above-the-fold truncation limits across X, LinkedIn, Instagram, TikTok, and Threads.";

export async function generateMetadata(): Promise<Metadata> {
  const canonicalUrl = "https://twistertools.com/tools/social-tools/social-character-counter";
  ...
  return {
    ...
    keywords: [
      ...
      "linkedin post limit checker",
      "instagram caption character limit",
      "utf-8 byte counter",
      "above the fold text hook",
...
export default function SocialCharacterCounterPage() {
  const toolUrl = "https://twistertools.com/tools/social-tools/social-character-counter";

  return (
    <div className="min-h-screen bg-background">
      {/* Page Header Strip */}
      <div className="border-b border-slate-200 bg-gradient-to-r from-slate-50/80 via-white to-indigo-50/70 dark:border-slate-700 dark:from-slate-900/50 dark:via-slate-950 dark:to-indigo-950/40">
          ...
          <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-5 shadow-sm dark:border-slate-700 dark:from-slate-900 dark:to-slate-800">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <div className="group relative">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free Social Media Character & Byte Limit Counter tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
