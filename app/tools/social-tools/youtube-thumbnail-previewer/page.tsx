...
import YouTubeThumbnailPreviewer from "@/components/tools/YouTubeThumbnailPreviewer";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "YouTube Thumbnail Safe Zone & Overlay Inspector";
const TOOL_SLUG = "youtube-thumbnail-previewer";
const TOOL_DESCRIPTION =
  "Inspect YouTube thumbnail safe zones, bottom-right timestamp collisions, desktop hover states, and mobile feed visibility in real-time 16:9 mockups.";
const TOOL_META_TITLE =
  "YouTube Thumbnail Safe Zone & Overlay Inspector";
const TOOL_META_DESCRIPTION =
  "Inspect YouTube thumbnail safe zones, bottom-right timestamp collisions, desktop hover states, and mobile feed visibility in real-time 16:9 mockups.";

export async function generateMetadata(): Promise<Metadata> {
  const canonicalUrl = "https://www.twistertools.com/tools/social-tools/youtube-thumbnail-previewer";
  ...
  return {
    ...
    keywords: [
      ...
      "youtube timestamp overlay inspector",
      "youtube thumbnail checker",
      "16:9 thumbnail preview",
      "youtube mobile feed thumbnail simulator",
      "twistertools"
    ],
    alternates: {
...
export default function YouTubeThumbnailPreviewerPage() {
  const toolUrl = "https://www.twistertools.com/tools/social-tools/youtube-thumbnail-previewer";

  return (
    <div className="min-h-screen bg-background">
      {/* Page Header Strip - Modern Ambient Studio Style (Fine-Tuned) */}
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-3.5">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              {/* Elevated Glass Plinth Icon Box */}
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-indigo-200/80 bg-gradient-to-br from-indigo-50 to-white p-1 shadow-xs shadow-indigo-100/60 dark:border-indigo-900/50 dark:from-slate-800 dark:to-slate-900 sm:h-14 sm:w-14 sm:rounded-2xl sm:p-2">
                <Tv className="h-6 w-6 text-indigo-600 dark:text-indigo-400 sm:h-9 sm:w-9" />
              </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-5 shadow-sm dark:border-slate-700 dark:from-slate-900 dark:to-slate-800">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <div className="group relative">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free YouTube Thumbnail Safe Zone & Overlay Inspector tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
