...
import TikTokBioFormatter from "@/components/tools/TikTokBioFormatter";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "TikTok Bio Link & Multi-Callout Generator";
const TOOL_SLUG = "tiktok-bio-formatter";
const TOOL_DESCRIPTION =
  "Format and optimize your TikTok bio within the strict 80-character limit. Add clean callout rows, direct website link funnels, and test with live mobile feed mockups.";
const TOOL_META_TITLE =
  "TikTok Bio Link & Multi-Callout Generator";
const TOOL_META_DESCRIPTION =
  "Format and optimize your TikTok bio within the strict 80-character limit. Add clean callout rows, direct website link funnels, and test with live mobile feed mockups.";

export async function generateMetadata(): Promise<Metadata> {
  const canonicalUrl = "https://twistertools.com/tools/social-tools/tiktok-bio-formatter";
  ...
  return {
    ...
    keywords: [
      ...
      "tiktok bio link formatter",
      "tiktok 80 character limit bio",
      "tiktok profile callouts",
      "tiktok link in bio optimizer",
      "tiktok bio preview simulation",
      "twistertools"
    ],
    alternates: {
...
export default function TikTokBioFormatterPage() {
  const toolUrl = "https://twistertools.com/tools/social-tools/tiktok-bio-formatter";
          ...
          <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-5 shadow-sm dark:border-slate-700 dark:from-slate-900 dark:to-slate-800">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <div className="group relative">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free TikTok Bio Link & Multi-Callout Generator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
