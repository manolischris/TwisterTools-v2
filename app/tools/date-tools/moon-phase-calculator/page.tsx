...
const TOOL_TITLE = "Moon Phase Calendar & Visualizer";
const TOOL_SLUG = "moon-phase-calculator";
...
const TOOL_META_DESCRIPTION =
  "Determine accurate lunar phases, illumination percentages, moon age, distance to Earth, and monthly calendar views for any coordinates using astronomical calculations.";
