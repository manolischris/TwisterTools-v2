...
import DaysBetweenDatesCalculator from "@/components/tools/DaysBetweenDatesCalculator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Days Between Dates & Span Calculator";
const TOOL_SLUG = "days-between-dates";
...
const TOOL_META_DESCRIPTION =
  "Free online days between dates calculator. Compute exact days, working business days, weeks, or perform date addition/subtraction in real-time.";
