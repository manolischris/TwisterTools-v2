...
const TOOL_TITLE = "Day of the Week Calculator";
const TOOL_SLUG = "day-of-week-calculator";
...
const TOOL_META_DESCRIPTION =
  "Free online day of the week calculator. Instantly check the day of the week for any birthday, historical event, or future date with complete zodiac and birthstone insights.";
