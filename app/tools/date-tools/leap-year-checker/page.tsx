...
const TOOL_TITLE = "Leap Year Checker & Calendar Auditor";
const TOOL_SLUG = "leap-year-checker";
const TOOL_DESCRIPTION =
  "Instantly verify leap years, century leap year rules, solar year deviations, and calendar range audits.";
const TOOL_META_DESCRIPTION =
  "Free online leap year checker and calendar auditor. Instantly verify leap years, century rules, solar deviations, and run date range audits.";
