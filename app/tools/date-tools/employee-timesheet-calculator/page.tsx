...
import EmployeeTimesheetCalculator from "@/components/tools/EmployeeTimesheetCalculator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Employee Timesheet & Overtime Pay Calculator";
const TOOL_SLUG = "employee-timesheet-calculator";
const TOOL_DESCRIPTION =
  "Calculate daily and weekly work hours, lunch break deductions, overtime (1.5x), California double time (2.0x), and export payroll CSVs.";
const TOOL_META_DESCRIPTION =
  "Free online timesheet calculator with automated daily and weekly overtime (1.5x/2.0x), California double time rules, lunch deductions, and CSV export.";
...
export default function EmployeeTimesheetCalculatorPage() {
