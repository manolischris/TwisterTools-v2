...
const TOOL_TITLE = "Event Countdown Timer Generator";
const TOOL_SLUG = "countdown-timer-generator";
const TOOL_DESCRIPTION =
  "Create customizable, embeddable countdown timers for launches, sales, and events.";
