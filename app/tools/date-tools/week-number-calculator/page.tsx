...
import WeekNumberCalculator from "@/components/tools/WeekNumberCalculator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Week Number Calculator (ISO-8601)";
const TOOL_SLUG = "week-number-calculator";
const TOOL_DESCRIPTION =
  "Calculate ISO-8601 week numbers, week date ranges, and annual week metrics.";
const TOOL_META_DESCRIPTION =
  "Calculate ISO-8601 week numbers, week date spans, and calendar metrics.";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: "ISO Week Number Calculator | TwisterTools",
      description: TOOL_META_DESCRIPTION,
      url: canonicalUrl,
