...
const TOOL_TITLE = "Time Duration & Hour Counter";
const TOOL_SLUG = "time-duration-calculator";
...
const TOOL_META_DESCRIPTION =
  "Free online time duration & hour counter. Calculate exact days, business working days, or perform date addition/subtraction in real-time.";
