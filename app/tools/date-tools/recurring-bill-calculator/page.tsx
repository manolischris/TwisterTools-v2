...
import RecurringBillCalculator from "@/components/tools/RecurringBillCalculator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Bill Due Date & Recurring Cycle Schedule Calculator";
const TOOL_SLUG = "recurring-bill-calculator";
const TOOL_DESCRIPTION =
  "Calculate recurring billing schedules, due dates, weekend banking shifts, and annualized expenses across weekly, bi-weekly, monthly, and quarterly intervals.";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [
      ...
      "recurring cycle schedule calculator",
      "payment schedule generator",
      "weekend banking adjustment",
      "annualized expense calculator",
...
export default function RecurringBillCalculatorPage() {
  const toolUrl = `https://www.twistertools.com/tools/date-tools/${TOOL_SLUG}`;

  return (
    <div className="min-h-screen bg-background">
      {/* Page Header Strip - Indigo-to-Slate Gradient */}
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-10 h-10 sm:w-14 sm:h-14 p-1 sm:p-2 rounded-xl sm:rounded-2xl shrink-0 flex items-center justify-center bg-indigo-50/70 dark:bg-slate-800 shadow-sm">
                <CalendarDays className="w-7 h-7 sm:w-10 sm:h-10 text-indigo-600 dark:text-indigo-400" />
              </div>
