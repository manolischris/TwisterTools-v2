...
import PaintCoverageCalculator from "@/components/tools/PaintCoverageCalculator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Wall Paint Coverage & Gallon Volume Estimator";
const TOOL_SLUG = "paint-coverage-calculator";
...
export async function generateMetadata(): Promise<Metadata> {
  const canonicalUrl = "https://twistertools.com/tools/home-tools/paint-coverage-calculator";
...
export default function PaintCoverageCalculatorPage() {
  const toolUrl = "https://twistertools.com/tools/home-tools/paint-coverage-calculator";
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-indigo-200/80 bg-gradient-to-br from-indigo-50 to-white p-1 shadow-xs shadow-indigo-100/60 dark:border-indigo-900/50 dark:from-slate-800 dark:to-slate-900 sm:h-14 sm:w-14 sm:rounded-2xl sm:p-2">
                <PaintBucket className="h-6 w-6 text-indigo-600 dark:text-indigo-400 sm:h-9 sm:w-9" />
              </div>
