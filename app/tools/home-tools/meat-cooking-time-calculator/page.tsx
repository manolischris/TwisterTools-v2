...
import MeatCookingCalculator from "@/components/tools/MeatCookingCalculator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Meat Roasting & Internal Cooking Temperature Guide";
const TOOL_SLUG = "meat-cooking-time-calculator";
const TOOL_DESCRIPTION =
  "Calculate exact meat roasting times, probe pull temperatures, carryover cooking margins, and serving schedules for prime rib, turkey, chicken, pork, and lamb.";

export async function generateMetadata(): Promise<Metadata> {
  const canonicalUrl = "https://twistertools.com/tools/home-tools/meat-cooking-time-calculator";
  ...
  return {
    ...
    openGraph: {
      title: "Meat Roasting & Internal Cooking Temperature Guide | TwisterTools",
      description: TOOL_DESCRIPTION,
      url: canonicalUrl,
...
export default function MeatCookingCalculatorPage() {
  const toolUrl = "https://twistertools.com/tools/home-tools/meat-cooking-time-calculator";
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-3.5">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="scrollbar-none mb-1.5 flex flex-wrap items-center gap-1 overflow-x-auto whitespace-nowrap text-xs text-slate-500 dark:text-slate-400">
              ...
              <Link className="max-w-32.5 truncate font-medium transition-colors hover:text-indigo-600 dark:hover:text-indigo-400 sm:max-w-50 md:max-w-none" href="/tools/home-tools">
