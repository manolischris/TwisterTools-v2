...
import LawnSeedCalculator from "@/components/tools/LawnSeedCalculator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Lawn Grass Seed & Fertilizer Spreading Rate Calculator";
const TOOL_SLUG = "lawn-seed-calculator";
const TOOL_DESCRIPTION =
  "Calculate precise seed pounds, N-P-K fertilizer rates, bag quantities, and cross-hatch spreader calibrations for cool and warm season lawns.";

export async function generateMetadata(): Promise<Metadata> {
  const canonicalUrl = "https://twistertools.com/tools/home-tools/lawn-seed-calculator";
  ...
  return {
    ...
    keywords: [
      ...
      "fertilizer spreading rate",
      "NPK calculator",
      "overseeding rate",
      "seeding rate lbs per 1000 sq ft",
      "lawn fertilizer calculator",
      "cross-hatch spreader calibration",
      "cool season grass seed",
      "warm season grass seed",
      "turfgrass calculator",
      "twistertools",
    ],
    alternates: {
...
export default function LawnSeedCalculatorPage() {
  const toolUrl = "https://twistertools.com/tools/home-tools/lawn-seed-calculator";
