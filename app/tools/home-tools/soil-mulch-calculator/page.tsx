...
import SoilMulchCalculator from "@/components/tools/SoilMulchCalculator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Mulch, Soil & Gravel Cubic Yard Estimator";
const TOOL_SLUG = "soil-mulch-calculator";
const TOOL_DESCRIPTION =
  "Calculate exact cubic yards, tons, and bagged quantities for mulch, topsoil, gravel, sand, and compost with multi-zone coverage, compaction adjustments, and bulk vs. bagged cost comparison.";

export async function generateMetadata(): Promise<Metadata> {
  const canonicalUrl = "https://twistertools.com/tools/home-tools/soil-mulch-calculator";
...
export default function SoilMulchCalculatorPage() {
  const toolUrl = "https://twistertools.com/tools/home-tools/soil-mulch-calculator";
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-indigo-200/80 bg-gradient-to-br from-indigo-50 to-white p-1 shadow-xs shadow-indigo-100/60 dark:border-indigo-900/50 dark:from-slate-800 dark:to-slate-900 sm:h-14 sm:w-14 sm:rounded-2xl sm:p-2">
                <Shovel className="h-6 w-6 text-indigo-600 dark:text-indigo-400 sm:h-9 sm:w-9" />
              </div>
