...
import DkimRecordGenerator from "@/components/tools/DkimRecordGenerator";
import RelatedTools from "@/components/RelatedTools";

const TOOL_TITLE = "DKIM Record Generator & Selector Key Inspector";
const TOOL_SLUG = "dkim-record-generator";
...
export async function generateMetadata(): Promise<Metadata> {
  const canonicalUrl = `https://www.twistertools.com/tools/web-tools/${TOOL_SLUG}`;
  ...
  const ogImageUrl = fs.existsSync(webpPath)
    ? `https://www.twistertools.com/images/tools/web-tools/${TOOL_SLUG}.webp`
    : fs.existsSync(jpgPath)
      ? `https://www.twistertools.com/images/tools/web-tools/${TOOL_SLUG}.jpg`
      : "https://www.twistertools.com/images/og-default.jpg";

  return {
    title: "DKIM Record Generator & Selector Key Inspector",
    description: TOOL_DESCRIPTION,
    keywords: [
      "dkim record generator",
      "dkim key generator",
      "dkim selector inspector",
      "rfc 6376 dkim",
      "dkim public key validator",
    ...
    openGraph: {
      title: "DKIM Record Generator & Selector Key Inspector | TwisterTools",
      description: TOOL_DESCRIPTION,
      url: canonicalUrl,
...
const DkimRecordGeneratorPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-3.5">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="scrollbar-none mb-1.5 flex flex-wrap items-center gap-1 overflow-x-auto whitespace-nowrap text-xs text-slate-500 dark:text-slate-400">
              ...
              <Link className="max-w-32.5 truncate font-medium transition-colors hover:text-indigo-600 dark:hover:text-indigo-400 sm:max-w-50 md:max-w-none" href="/tools/web-tools">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-indigo-200/80 bg-gradient-to-br from-indigo-50 to-white p-1 shadow-xs shadow-indigo-100/60 dark:border-indigo-900/50 dark:from-slate-800 dark:to-slate-900 sm:h-14 sm:w-14 sm:rounded-2xl sm:p-2">
                <KeyRound className="h-6 w-6 text-indigo-600 dark:text-indigo-400 sm:h-9 sm:w-9" />
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-3 sm:py-3.5 md:py-4">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`https://www.twistertools.com/tools/web-tools/${TOOL_SLUG}`)}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(`https://www.twistertools.com/tools/web-tools/${TOOL_SLUG}`)}&text=${encodeURIComponent("Check out this DKIM Record Generator & Selector Key Inspector tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`https://www.twistertools.com/tools/web-tools/${TOOL_SLUG}`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug={TOOL_SLUG} currentCategory="web-tools" />
        </div>
      </div>
    </div>
  );
...
export default DkimRecordGeneratorPage;
