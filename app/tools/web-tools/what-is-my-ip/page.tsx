...
export async function generateMetadata() {
  ...
  const imagePath = path.join(process.cwd(), "public", "images", "tools", "web-tools", "what-is-my-ip.jpg");
  const imageExists = fs.existsSync(imagePath);
  const ogImageUrl = imageExists
    ? "https://www.twistertools.com/images/tools/web-tools/what-is-my-ip.jpg"
    : "https://www.twistertools.com/images/og-default.jpg";

  return {
    title: "What Is My IP Address & Network Inspector",
    description: "Check your public IPv4/IPv6 address, ISP details, geolocation, and connection security in real time.",
    keywords: ["what is my ip", "ip address", "ipv4", "ipv6", "network inspector", "isp lookup", "geolocation", "ip lookup", "public ip", "twistertools"],
    openGraph: {
      title: "What Is My IP Address & Network Inspector | TwisterTools",
      description: "Check your public IPv4/IPv6 address, ISP details, geolocation, and connection security in real time.",
      url: pageUrl,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "What Is My IP Address & Network Inspector on TwisterTools",
        },
      ],
    },
    twitter: {
...
export default function WhatIsMyIpPage() {
  const toolUrl = "https://www.twistertools.com/tools/web-tools/what-is-my-ip";
          ...
          <div className="bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free What Is My IP Address & Network Inspector tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
