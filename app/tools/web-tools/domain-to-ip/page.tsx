...
export async function generateMetadata() {
  ...
  const imagePath = path.join(process.cwd(), "public", "images", "tools", "web-tools", "domain-to-ip.jpg");
  const imageExists = fs.existsSync(imagePath);
  const ogImageUrl = imageExists
    ? "https://www.twistertools.com/images/tools/web-tools/domain-to-ip.jpg"
    : "https://www.twistertools.com/images/og-default.jpg";

  return {
    title: "Domain to IP Converter & DNS Inspector",
    description: "Instantly resolve domain names into IPv4/IPv6 addresses, inspect A-records, ISP metadata, and server locations. Free online DNS lookup tool — 100% client-side.",
    keywords: ["domain to ip", "dns lookup", "ip resolver", "domain converter", "dns inspector", "ip address lookup", "dns a record", "isp lookup", "online dns tool", "twistertools"],
    openGraph: {
      title: "Domain to IP Converter & DNS Inspector | TwisterTools",
      description: "Instantly resolve domain names into IPv4/IPv6 addresses, inspect A-records, ISP metadata, and server locations. Free online DNS lookup tool.",
      url: pageUrl,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Domain to IP Converter & DNS Inspector on TwisterTools",
        },
      ],
    },
    twitter: {
      ...
      title: "Domain to IP Converter & DNS Inspector | TwisterTools",
      description: "Instantly resolve domain names into IPv4/IPv6 addresses, inspect A-records, ISP metadata, and server locations.",
      images: [ogImageUrl],
    },
    alternates: {
      canonical: pageUrl,
...
export default function DomainToIpPage() {
  const toolUrl = "https://www.twistertools.com/tools/web-tools/domain-to-ip";
          ...
          <div className="bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free Domain to IP Converter & DNS Inspector tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
