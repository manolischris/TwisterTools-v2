...
export async function generateMetadata() {
  ...
  const imagePath = path.join(process.cwd(), "public", "images", "tools", "web-tools", "sitemap-generator.jpg");
  const imageExists = fs.existsSync(imagePath);
  const ogImageUrl = imageExists
    ? "https://www.twistertools.com/images/tools/web-tools/sitemap-generator.jpg"
    : "https://www.twistertools.com/images/og-default.jpg";

  return {
    title: "XML Sitemap Generator & URL Crawler Suite",
    description: "Free online XML sitemap generator. Compile Sitemaps.org compliant XML, TXT, and HTML sitemaps with priority, lastmod, and changefreq controls.",
    keywords: ["xml sitemap generator", "sitemap generator", "url crawler", "seo sitemap", "google sitemap", "sitemap.xml", "twistertools"],
    openGraph: {
      title: "XML Sitemap Generator & URL Crawler Suite | TwisterTools",
      description: "Free online XML sitemap generator. Compile Sitemaps.org compliant XML, TXT, and HTML sitemaps with priority, lastmod, and changefreq controls.",
      url: pageUrl,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "XML Sitemap Generator & URL Crawler Suite on TwisterTools",
        },
      ],
    },
    twitter: {
...
export default function SitemapGeneratorPage() {
  const toolUrl = "https://www.twistertools.com/tools/web-tools/sitemap-generator";
          ...
          <div className="bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free XML Sitemap Generator & URL Crawler Suite tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
