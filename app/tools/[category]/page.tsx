...
import { Link as LinkIcon,
  ...
  Baseline,
  Trophy,
  Shuffle, PenTool, Smile, Gamepad2, VectorSquare, Code2 } from "lucide-react";
...
> = {
  ...
  "health-tools": {
    ...
    seoDescription: "Fast, privacy-first body composition calculators, athletic performance estimators, sleep and metabolic trackers, and clinical wellness utilities.",
    keywords: ["bmi calculator", "tdee calculator", "calorie deficit", "body fat percentage", "target heart rate zones", "sleep cycle tracker"],
    cards: [
      {
