...
export const metadata: Metadata = {
  ...
  description:
    "Convert JPG, PNG, and WEBP images into a clean PDF document instantly with customizable margins and page sizes. 100% free and client-side.",
  keywords: [
    "jpg to pdf",
    "png to pdf",
    "webp to pdf",
  ...
  openGraph: {
    title: "JPG to PDF Converter | TwisterTools",
    description:
      "Convert JPG, PNG, and WEBP images into a clean PDF document instantly with customizable margins and page sizes. 100% free and client-side.",
    url: "https://www.twistertools.com/tools/pdf-tools/jpg-to-pdf",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/pdf-tools/jpg-to-pdf.jpg",
        width: 1200,
        height: 630,
        alt: "JPG to PDF Converter Tool on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Convert JPG, PNG, and WEBP images into a clean PDF document instantly with customizable margins and page sizes. 100% free and client-side.",
    images: [
      "https://www.twistertools.com/images/tools/pdf-tools/jpg-to-pdf.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/pdf-tools/jpg-to-pdf",
  },
};
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/jpg-to-pdf")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/jpg-to-pdf")}&text=${encodeURIComponent("Convert JPG, PNG, and WEBP images into a clean PDF document instantly with customizable margins and page sizes. 100% free and client-side.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/jpg-to-pdf")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="jpg-to-pdf" currentCategory="pdf-tools" />
        </div>
      </div>
    </div>
  );
