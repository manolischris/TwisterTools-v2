...
export const metadata: Metadata = {
  title: "Crop PDF Pages & Margin Trimmer",
  description:
    "Trim margins and crop custom page areas client-side with zero quality loss.",
  keywords: [
    "crop pdf pages",
    "trim pdf margins",
    "pdf margin trimmer",
    "crop pdf online",
    "pdf crop tool",
    "client-side pdf crop",
    "twistertools",
  ],
  openGraph: {
    title: "Crop PDF Pages & Margin Trimmer | TwisterTools",
    description:
      "Trim margins and crop custom page areas client-side with zero quality loss.",
    url: "https://www.twistertools.com/tools/pdf-tools/crop-pdf",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/pdf-tools/crop-pdf.jpg",
        width: 1200,
        height: 630,
        alt: "Crop PDF Pages & Margin Trimmer on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Trim margins and crop custom page areas client-side with zero quality loss.",
    images: [
      "https://www.twistertools.com/images/tools/pdf-tools/crop-pdf.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/pdf-tools/crop-pdf",
  },
};
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/crop-pdf")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/crop-pdf")}&text=${encodeURIComponent("Trim margins and crop custom page areas client-side with zero quality loss.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/crop-pdf")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="crop-pdf" currentCategory="pdf-tools" />
        </div>
      </div>
    </div>
  );
