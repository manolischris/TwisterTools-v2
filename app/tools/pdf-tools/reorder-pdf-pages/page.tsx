...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "rotate pdf pages",
    "pdf organizer",
    "client-side pdf reorder",
    "twistertools",
  ],
  openGraph: {
    title: "Reorder & Reverse PDF Pages | TwisterTools",
    description:
      "Rearrange, reverse, rotate, and organize PDF pages easily inside your browser. 100% free, fast, and secure client-side PDF tool.",
    url: "https://www.twistertools.com/tools/pdf-tools/reorder-pdf-pages",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/pdf-tools/reorder-pdf-pages.jpg",
        width: 1200,
        height: 630,
        alt: "Reorder & Reverse PDF Pages on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Rearrange, reverse, rotate, and organize PDF pages easily inside your browser. 100% free, fast, and secure client-side PDF tool.",
    images: [
      "https://www.twistertools.com/images/tools/pdf-tools/reorder-pdf-pages.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/pdf-tools/reorder-pdf-pages",
  },
};

const ReorderPdfPagesPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/reorder-pdf-pages")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/reorder-pdf-pages")}&text=${encodeURIComponent("Rearrange, reverse, rotate, and organize PDF pages easily inside your browser.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/reorder-pdf-pages")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="reorder-pdf-pages" currentCategory="pdf-tools" />
        </div>
      </div>
    </div>
  );
