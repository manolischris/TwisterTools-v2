...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "PDF to Markdown Converter | TwisterTools",
    description:
      "Convert PDF documents to clean Markdown code client-side with full structural accuracy.",
    url: "https://www.twistertools.com/tools/pdf-tools/pdf-to-markdown",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/pdf-tools/pdf-to-markdown.jpg",
        width: 1200,
        height: 630,
        alt: "PDF to Markdown Converter on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Convert PDF documents to clean Markdown code client-side with full structural accuracy.",
    images: [
      "https://www.twistertools.com/images/tools/pdf-tools/pdf-to-markdown.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/pdf-tools/pdf-to-markdown",
  },
};

const PdfToMarkdownPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/pdf-to-markdown")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/pdf-to-markdown")}&text=${encodeURIComponent("Convert PDF documents to clean Markdown code client-side with full structural accuracy.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/pdf-to-markdown")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="pdf-to-markdown" currentCategory="pdf-tools" />
        </div>
      </div>
    </div>
  );
