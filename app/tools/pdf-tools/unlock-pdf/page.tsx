...
export const metadata: Metadata = {
  title: "Unlock PDF & Password Remover - TwisterTools",
  description:
  ...
  openGraph: {
    ...
    description:
      "Unlock password-protected PDF files directly in your browser with zero file uploads.",
    url: "https://www.twistertools.com/tools/pdf-tools/unlock-pdf",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/pdf-tools/unlock-pdf.jpg",
        width: 1200,
        height: 630,
        alt: "Unlock PDF & Password Remover on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Unlock password-protected PDF files directly in your browser with zero file uploads.",
    images: [
      "https://www.twistertools.com/images/tools/pdf-tools/unlock-pdf.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/pdf-tools/unlock-pdf",
  },
};
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-10 h-10 sm:w-14 sm:h-14 p-1 sm:p-2 rounded-xl sm:rounded-2xl shrink-0 flex items-center justify-center bg-indigo-50/70 dark:bg-slate-800 shadow-sm">
                <Unlock className="w-7 h-7 sm:w-10 sm:h-10 text-indigo-600 dark:text-indigo-400" />
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/unlock-pdf")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/unlock-pdf")}&text=${encodeURIComponent("Unlock password-protected PDF files directly in your browser with zero file uploads.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/unlock-pdf")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <RelatedTools currentSlug="unlock-pdf" currentCategory="pdf-tools" />
        </div>
      </div>
    </div>
  );
