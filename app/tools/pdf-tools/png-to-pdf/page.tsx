...
import PngToPdfConverter from "@/components/tools/PngToPdfConverter";
import RelatedTools from "@/components/RelatedTools";

export const metadata: Metadata = {
  title: "PNG to PDF Converter - Free, High Quality & Private | TwisterTools",
  description:
    "Convert PNG images to PDF documents instantly in your browser. Preserves transparency and full image quality with custom page sizes and zero server uploads.",
  keywords: [
    "png to pdf",
    "convert png to pdf",
    "png to pdf converter",
    "png to pdf transparent",
    "offline png to pdf",
    "client-side png to pdf",
    "twistertools",
  ],
  openGraph: {
    title: "PNG to PDF Converter - Free, High Quality & Private | TwisterTools",
    description:
      "Convert PNG images to PDF documents instantly in your browser. Preserves transparency and full image quality with custom page sizes and zero server uploads.",
    url: "https://www.twistertools.com/tools/pdf-tools/png-to-pdf",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/pdf-tools/png-to-pdf.jpg",
        width: 1200,
        height: 630,
        alt: "PNG to PDF Converter Tool on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Convert PNG images to PDF documents instantly in your browser. Preserves transparency and full image quality with custom page sizes and zero server uploads.",
    images: [
      "https://www.twistertools.com/images/tools/pdf-tools/png-to-pdf.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/pdf-tools/png-to-pdf",
  },
};

const PngToPdfPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs sm:text-sm md:text-base text-slate-600 dark:text-slate-400 leading-relaxed line-clamp-2 sm:line-clamp-none">
                  Convert transparent or high-res PNG images into clean PDF documents locally in your web browser.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/png-to-pdf")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/png-to-pdf")}&text=${encodeURIComponent("Convert transparent or high-res PNG images into clean PDF documents locally in your web browser. 100% free and client-side.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/png-to-pdf")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="png-to-pdf" currentCategory="pdf-tools" />
        </div>
      </div>
    </div>
  );
