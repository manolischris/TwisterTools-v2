...
export const metadata: Metadata = {
  ...
  description:
    "Convert PowerPoint slides (.pptx) to high-resolution PDF documents directly in your browser with 100% privacy.",
  keywords: [
    "ppt to pdf",
    "pptx to pdf",
    "convert powerpoint to pdf",
    "powerpoint to pdf converter",
    "client-side ppt conversion",
    "twistertools",
  ],
  openGraph: {
    title: "PPT to PDF Presentation Converter | TwisterTools",
    description:
      "Convert PowerPoint slides (.pptx) to high-resolution PDF documents directly in your browser with 100% privacy.",
    url: "https://www.twistertools.com/tools/pdf-tools/ppt-to-pdf",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/pdf-tools/ppt-to-pdf.jpg",
        width: 1200,
        height: 630,
        alt: "PPT to PDF Presentation Converter Tool on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Convert PowerPoint slides (.pptx) to high-resolution PDF documents directly in your browser with 100% privacy.",
    images: [
      "https://www.twistertools.com/images/tools/pdf-tools/ppt-to-pdf.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/pdf-tools/ppt-to-pdf",
  },
};
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400 mb-1.5 font-medium">
              ...
              <span className="text-slate-900 dark:text-white">
                PPT to PDF Presentation Converter
              </span>
            </div>
            ...
            <div className="flex items-start gap-3 mt-2">
              <div className="w-14 h-14 rounded-2xl flex self-stretch items-center justify-center flex-shrink-0 bg-indigo-50/70 dark:bg-slate-800 shadow-sm">
                <Presentation className="w-10 h-10 text-indigo-600 dark:text-indigo-400" />
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/ppt-to-pdf")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/ppt-to-pdf")}&text=${encodeURIComponent("Convert PowerPoint slides (.pptx) to high-resolution PDF documents directly in your browser with 100% privacy.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/ppt-to-pdf")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="ppt-to-pdf" currentCategory="pdf-tools" />
        </div>
      </div>
    </div>
  );
