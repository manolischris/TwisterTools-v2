...
export const metadata: Metadata = {
  title: "Image to PDF Universal Converter",
  description:
    "Convert JPG, PNG, and WEBP images into organized multi-page PDF documents locally in your browser. 100% free and client-side.",
  keywords: [
    "image to pdf",
    "jpg to pdf",
    "png to pdf",
  ...
  openGraph: {
    title: "Image to PDF Universal Converter | TwisterTools",
    description:
      "Convert JPG, PNG, and WEBP images into organized multi-page PDF documents locally in your browser. 100% free and client-side.",
    url: "https://www.twistertools.com/tools/pdf-tools/image-to-pdf",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/pdf-tools/image-to-pdf.jpg",
        width: 1200,
        height: 630,
        alt: "Image to PDF Universal Converter Tool on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Convert JPG, PNG, and WEBP images into organized multi-page PDF documents locally in your browser. 100% free and client-side.",
    images: [
      "https://www.twistertools.com/images/tools/pdf-tools/image-to-pdf.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/pdf-tools/image-to-pdf",
  },
};
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-1 text-xs text-slate-600 dark:text-slate-400 mb-2 truncate font-medium flex-wrap overflow-x-auto whitespace-nowrap scrollbar-none">
              ...
              <span className="text-slate-900 dark:text-white max-w-[130px] sm:max-w-[200px] md:max-w-none truncate">
                Image to PDF Universal Converter
              </span>
            </div>
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs sm:text-sm md:text-base text-slate-600 dark:text-slate-400 leading-relaxed line-clamp-2 sm:line-clamp-none">
                  Convert JPG, PNG, and WEBP images into organized multi-page PDF documents locally in your browser.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/image-to-pdf")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/image-to-pdf")}&text=${encodeURIComponent("Convert JPG, PNG, and WEBP images into organized multi-page PDF documents locally in your browser. 100% free and client-side.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/image-to-pdf")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="image-to-pdf" currentCategory="pdf-tools" />
        </div>
      </div>
    </div>
  );
