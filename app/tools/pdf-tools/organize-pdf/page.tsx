...
import OrganizePdfSuite from "@/components/tools/OrganizePdfSuite";
import RelatedTools from "@/components/RelatedTools";

export const metadata: Metadata = {
  title: "Organize & Split PDF Pages",
  description:
  ...
  openGraph: {
    title: "Organize & Split PDF Pages - TwisterTools",
    description:
      "Reorder, rotate, delete, split, and extract PDF pages directly in your browser with zero file uploads and complete client-side security.",
    url: "https://www.twistertools.com/tools/pdf-tools/organize-pdf",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/pdf-tools/organize-pdf.jpg",
        width: 1200,
        height: 630,
        alt: "Organize & Split PDF Pages on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Reorder, rotate, delete, split, and extract PDF pages directly in your browser with zero file uploads and complete client-side security.",
    images: [
      "https://www.twistertools.com/images/tools/pdf-tools/organize-pdf.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/pdf-tools/organize-pdf",
  },
};
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/organize-pdf")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/organize-pdf")}&text=${encodeURIComponent("Reorder, rotate, delete, split, and extract PDF pages directly in your browser with zero file uploads and complete client-side security.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/organize-pdf")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <RelatedTools currentSlug="organize-pdf" currentCategory="pdf-tools" />
        </div>
      </div>
    </div>
  );
