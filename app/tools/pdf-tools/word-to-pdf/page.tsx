...
export const metadata: Metadata = {
  ...
  description:
    "Convert Word (.docx) documents to PDF format directly in your browser with full privacy, visual preview, custom margins, and zero server uploads.",
  keywords: [
    "word to pdf",
    "docx to pdf",
    "convert docx to pdf",
    "convert word to pdf offline",
    "client-side word to pdf",
  ...
  openGraph: {
    ...
    description:
      "Convert Word (.docx) documents to PDF format directly in your browser with full privacy, visual preview, custom margins, and zero server uploads.",
    url: "https://www.twistertools.com/tools/pdf-tools/word-to-pdf",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/pdf-tools/word-to-pdf.jpg",
        width: 1200,
        height: 630,
        alt: "Word to PDF Converter Tool on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Convert Word (.docx) documents to PDF format directly in your browser with full privacy, visual preview, custom margins, and zero server uploads.",
    images: [
      "https://www.twistertools.com/images/tools/pdf-tools/word-to-pdf.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/pdf-tools/word-to-pdf",
  },
};
    ...
    <div className="min-h-screen bg-background">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-10 h-10 sm:w-14 sm:h-14 p-1 sm:p-2 rounded-xl sm:rounded-2xl shrink-0 flex items-center justify-center bg-indigo-50/70 dark:bg-slate-800 shadow-sm">
                <FileType className="w-7 h-7 sm:w-10 sm:h-10 text-indigo-600 dark:text-indigo-400" />
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/word-to-pdf")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/word-to-pdf")}&text=${encodeURIComponent("Convert Microsoft Word (.docx) documents to PDF format instantly with complete privacy and zero server uploads.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/word-to-pdf")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="word-to-pdf" currentCategory="pdf-tools" />
        </div>
      </div>
    </div>
  );
