...
export const metadata: Metadata = {
  ...
  description:
    "Convert PDF documents into high-resolution, lossless PNG images with custom DPI settings and transparency. 100% free and client-side.",
  keywords: [
    "pdf to png",
    "pdf image converter",
    "extract png from pdf",
    "pdf page rasterizer",
    "lossless pdf convert",
    "twistertools",
  ],
  openGraph: {
    title: "PDF to PNG Converter | TwisterTools",
    description:
      "Convert PDF documents into high-resolution, lossless PNG images with custom DPI settings and transparency. 100% free and client-side.",
    url: "https://www.twistertools.com/tools/pdf-tools/pdf-to-png",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/pdf-tools/pdf-to-png.jpg",
        width: 1200,
        height: 630,
        alt: "PDF to PNG Converter Tool on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Convert PDF documents into high-resolution, lossless PNG images with custom DPI settings and transparency. 100% free and client-side.",
    images: [
      "https://www.twistertools.com/images/tools/pdf-tools/pdf-to-png.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/pdf-tools/pdf-to-png",
  },
};

const PdfToPngPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/pdf-to-png")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/pdf-to-png")}&text=${encodeURIComponent("Convert PDF documents into high-resolution, lossless PNG images with custom DPI settings and transparency.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/pdf-to-png")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="pdf-to-png" currentCategory="pdf-tools" />
        </div>
      </div>
    </div>
  );
