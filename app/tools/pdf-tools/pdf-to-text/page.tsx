...
import PdfToTextExtractor from "@/components/tools/PdfToTextExtractor";
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "convert pdf to txt",
    "pdf plain text",
    "client-side pdf to text",
    "twistertools",
  ],
  openGraph: {
    title: "PDF to Plain Text Extractor | TwisterTools",
    description:
      "Extract clean, readable plain text from PDF documents instantly in your browser with zero server uploads.",
    url: "https://www.twistertools.com/tools/pdf-tools/pdf-to-text",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/pdf-tools/pdf-to-text.jpg",
        width: 1200,
        height: 630,
        alt: "PDF to Plain Text Extractor on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Extract clean, readable plain text from PDF documents instantly in your browser with zero server uploads.",
    images: [
      "https://www.twistertools.com/images/tools/pdf-tools/pdf-to-text.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/pdf-tools/pdf-to-text",
  },
};

const PdfToTextPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/pdf-to-text")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/pdf-to-text")}&text=${encodeURIComponent("Extract clean, readable plain text from PDF documents instantly in your browser.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/pdf-to-text")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="pdf-to-text" currentCategory="pdf-tools" />
        </div>
      </div>
    </div>
  );
