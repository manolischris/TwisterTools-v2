...
export const metadata: Metadata = {
  title: "PDF to Word Converter - Free & Secure Client-Side Tool | TwisterTools",
  description:
  ...
  openGraph: {
    ...
    description:
      "Convert PDF files into editable Word (.docx) documents directly in your browser with complete privacy and zero server uploads.",
    url: "https://www.twistertools.com/tools/pdf-tools/pdf-to-word",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/pdf-tools/pdf-to-word.jpg",
        width: 1200,
        height: 630,
        alt: "PDF to Word Converter Tool on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Convert PDF files into editable Word (.docx) documents directly in your browser with complete privacy and zero server uploads.",
    images: [
      "https://www.twistertools.com/images/tools/pdf-tools/pdf-to-word.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/pdf-tools/pdf-to-word",
  },
};
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/pdf-to-word")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/pdf-to-word")}&text=${encodeURIComponent("Convert PDF files into editable Word (.docx) documents directly in your browser with complete privacy and zero server uploads.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/pdf-to-word")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          {/* Related Tools */}
          <RelatedTools currentSlug="pdf-to-word" currentCategory="pdf-tools" />
        </div>
      </div>
    </div>
  );
