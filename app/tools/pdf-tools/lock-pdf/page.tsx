...
import LockPdfSuite from "@/components/tools/LockPdfSuite";
import RelatedTools from "@/components/RelatedTools";

export const metadata: Metadata = {
  title: "Lock PDF & Password Encryption - 100% Free & Private | TwisterTools",
  description:
    "Secure and lock PDF files with AES 256-bit password encryption directly in your browser. Restrict printing, copying, and editing with complete client-side privacy.",
  keywords: [
    "lock pdf",
    "encrypt pdf",
  ...
  openGraph: {
    ...
    description:
      "Secure and lock PDF files with AES 256-bit password encryption directly in your browser. Restrict printing, copying, and editing with complete client-side privacy.",
    url: "https://www.twistertools.com/tools/pdf-tools/lock-pdf",
    siteName: "TwisterTools",
    type: "website",
    images: [
      {
        url: "https://www.twistertools.com/images/tools/pdf-tools/lock-pdf.jpg",
        width: 1200,
        height: 630,
        alt: "Lock PDF & Password Encryption on TwisterTools",
      },
    ],
  },
  twitter: {
    ...
    description:
      "Secure and lock PDF files with AES 256-bit password encryption directly in your browser. Restrict printing, copying, and editing with complete client-side privacy.",
    images: [
      "https://www.twistertools.com/images/tools/pdf-tools/lock-pdf.jpg",
    ],
  },
  alternates: {
    canonical: "https://www.twistertools.com/tools/pdf-tools/lock-pdf",
  },
};

const LockPdfPage: NextPage = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6">
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/lock-pdf")}`}
                    target="_blank"
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/lock-pdf")}&text=${encodeURIComponent("Secure your PDF documents with AES 256-bit password encryption and control viewing or modification permissions locally.")}`}
                    target="_blank"
                    rel="noopener noreferrer"
                ...
                <div className="relative group">
                  <a
                    href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent("https://www.twistertools.com/tools/pdf-tools/lock-pdf")}`}
                    target="_blank"
                    rel="noopener noreferrer"
          ...
          <RelatedTools currentSlug="lock-pdf" currentCategory="pdf-tools" />
        </div>
      </div>
    </div>
  );
