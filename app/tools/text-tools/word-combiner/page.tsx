...
export async function generateMetadata() {
  ...
  const imagePath = path.join(process.cwd(), "public", "images", "tools", "text-tools", "word-combiner.jpg");
  const imageExists = fs.existsSync(imagePath);
  const ogImageUrl = imageExists
    ? "https://www.twistertools.com/images/tools/text-tools/word-combiner.jpg"
    : "https://www.twistertools.com/images/og-default.jpg";

  return {
    title: "Word Combiner & Phrase Generator",
    description: "Combine word lists into custom phrase matrices, domain names, and SEO keyword permutations instantly.",
    keywords: ["word combiner", "phrase generator", "keyword generator", "word list merger", "domain name generator", "seo keywords", "word permutation", "twistertools"],
    openGraph: {
      title: "Word Combiner & Phrase Generator | TwisterTools",
      description: "Combine word lists into custom phrase matrices, domain names, and SEO keyword permutations instantly.",
      url: pageUrl,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Word Combiner & Phrase Generator on TwisterTools",
        },
      ],
    },
    twitter: {
...
export default function WordCombinerPage() {
  const toolUrl = "https://www.twistertools.com/tools/text-tools/word-combiner";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-3 sm:py-3.5 md:py-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex items-center gap-1 text-xs text-slate-600 dark:text-slate-400 mb-2 truncate flex-wrap overflow-x-auto whitespace-nowrap scrollbar-none">
              ...
              <span>/</span>
              <span className="text-slate-900 dark:text-white max-w-[130px] sm:max-w-[200px] md:max-w-none truncate">Word Combiner & Phrase Generator</span>
            </div>
          ...
          <div className="bg-gradient-to-br from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl p-5 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative group">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free Word Combiner & Phrase Generator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
