...
import UrlOpener from "@/components/tools/UrlOpener";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Bulk Multi-URL Opener & Launch Sandbox";
const TOOL_SLUG = "url-opener";
...
const TOOL_META_DESCRIPTION =
  "Open hundreds of URLs at once in separate browser tabs. Sanitize, deduplicate, throttle, and batch-launch large URL lists securely client-side with zero server uploads.";
          ...
          <div className="rounded-2xl border border-slate-200 bg-linear-to-br from-slate-50 to-white p-5 shadow-sm dark:border-slate-700 dark:from-slate-900 dark:to-slate-800">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <div className="group relative">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free Bulk Multi-URL Opener & Launch Sandbox tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
