...
const TOOL_TITLE = "Text to ASCII Art & Banner Typography Generator";
const TOOL_SLUG = "ascii-art-generator";
...
const TOOL_META_DESCRIPTION =
  "Free online text to ASCII art generator. Convert plain text into FIGlet 3D banners, Unicode fonts, and framed code header comments instantly.";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: "Text to ASCII Art & Banner Typography Generator | TwisterTools",
      description: TOOL_META_DESCRIPTION,
      url: canonicalUrl,
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="scrollbar-none mb-1.5 flex flex-wrap items-center gap-1 overflow-x-auto whitespace-nowrap text-sm text-slate-600 dark:text-slate-400">
              ...
              <span className="max-w-32.5 truncate font-medium text-slate-900 dark:text-white sm:max-w-50 md:max-w-none">
                ASCII Art &amp; Typography Generator
              </span>
            </div>
