...
const TOOL_TITLE = "Title Case Converter for Capitalization Standards";
const TOOL_SLUG = "title-case-converter";
const TOOL_DESCRIPTION =
  "Format headlines and academic citations into APA, Chicago, MLA, AP, and NYT guidelines with custom acronym preservation.";
const TOOL_META_DESCRIPTION =
  "Convert headlines and titles to APA 7th, Chicago Manual of Style, MLA 9th, and AP guidelines instantly.";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Title Case Converter for Capitalization Standards (APA, Chicago, MLA, AP)",
    ...
    openGraph: {
      title: "Title Case Converter for Capitalization Standards (APA, Chicago, MLA, AP) | TwisterTools",
      description: TOOL_META_DESCRIPTION,
      url: canonicalUrl,
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-start gap-4">
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-indigo-50/70 shadow-sm dark:bg-slate-800">
                <Type className="h-8 w-8 text-indigo-600 dark:text-indigo-400" />
              </div>
