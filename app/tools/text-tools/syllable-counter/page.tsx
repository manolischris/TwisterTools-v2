...
const TOOL_TITLE = "Text Syllable Counter & Lexical Density Analyzer";
const TOOL_SLUG = "syllable-counter";
const TOOL_DESCRIPTION =
  "Free online syllable counter, lexical density scanner, readability grade calculator, and phonetic distribution visualizer. Analyze words and readability in real-time.";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: "Text Syllable Counter & Lexical Density Analyzer | TwisterTools",
      description: TOOL_DESCRIPTION,
      url: canonicalUrl,
          ...
          <div className="rounded-2xl border border-slate-200 bg-linear-to-br from-slate-50 to-white p-5 shadow-sm dark:border-slate-700 dark:from-slate-900 dark:to-slate-800">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <div className="group relative">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free Text Syllable Counter & Lexical Density Analyzer!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
