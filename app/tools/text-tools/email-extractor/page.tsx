...
const TOOL_TITLE = "Email Address Extractor & Scraper";
const TOOL_SLUG = "email-extractor";
const TOOL_DESCRIPTION =
  "Extract, clean, filter, and sort email addresses instantly from raw text, code logs, or unstructured documents.";
const TOOL_META_DESCRIPTION =
  "Extract, clean, filter, and sort email addresses instantly from raw text, code logs, or unstructured documents. 100% client-side, zero server uploads.";
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-10 h-10 sm:w-14 sm:h-14 p-1 sm:p-2 rounded-xl sm:rounded-2xl shrink-0 flex items-center justify-center bg-indigo-50/70 dark:bg-slate-800 shadow-sm">
                <AtSign className="w-7 h-7 sm:w-10 sm:h-10 text-indigo-600 dark:text-indigo-400" />
              </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-linear-to-br from-slate-50 to-white p-5 shadow-sm dark:border-slate-700 dark:from-slate-900 dark:to-slate-800">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <div className="group relative">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free Email Address Extractor & Scraper tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
