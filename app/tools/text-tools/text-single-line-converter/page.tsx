...
import TextSingleLineConverter from "@/components/tools/TextSingleLineConverter";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Plain Text to Single-Line Minifier";
const TOOL_SLUG = "text-single-line-converter";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: "Plain Text to Single-Line Minifier | TwisterTools",
      description: TOOL_DESCRIPTION,
      url: canonicalUrl,
...
export default function TextSingleLineConverterPage() {
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-center gap-3">
              <div className="flex h-14 w-14 shrink-0 self-stretch items-center justify-center rounded-2xl bg-indigo-50/70 shadow-sm dark:bg-slate-800">
                <AlignLeft className="h-10 w-10 text-indigo-600 dark:text-indigo-400" />
              </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-linear-to-br from-slate-50 to-white p-5 shadow-sm dark:border-slate-700 dark:from-slate-900 dark:to-slate-800">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <div className="group relative">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free Plain Text to Single-Line Minifier tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
