...
import TextPiiRedactor from "@/components/tools/TextPiiRedactor";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Text Anonymizer & PII Redactor";
const TOOL_SLUG = "text-pii-redactor";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: "Text Anonymizer & PII Redactor | TwisterTools",
      description: TOOL_META_DESCRIPTION,
      url: canonicalUrl,
...
export default function TextPiiRedactorPage() {
