...
import PrefixSuffixAttacher from "@/components/tools/PrefixSuffixAttacher";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Prefix and Suffix Text Attacher";
const TOOL_SLUG = "prefix-suffix-attacher";
...
const TOOL_META_DESCRIPTION =
  "Prepend and append custom text, tags, code syntax, or line numbers to each line of text instantly in your browser. Clean client-side line prefixer and suffixer.";
...
export default function PrefixSuffixAttacherPage() {
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-center gap-3">
              <div className="flex h-14 w-14 shrink-0 self-stretch items-center justify-center rounded-2xl bg-indigo-50/70 shadow-sm dark:bg-slate-800">
                <ArrowRightLeft className="h-10 w-10 text-indigo-600 dark:text-indigo-400" />
              </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-linear-to-br from-slate-50 to-white p-5 shadow-sm dark:border-slate-700 dark:from-slate-900 dark:to-slate-800">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <div className="group relative">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free Prefix and Suffix Text Attacher tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
