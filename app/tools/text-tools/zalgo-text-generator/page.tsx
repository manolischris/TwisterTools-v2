...
import ZalgoTextGenerator from "@/components/tools/ZalgoTextGenerator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Zalgo Glitch Text Generator";
const TOOL_SLUG = "zalgo-text-generator";
const TOOL_DESCRIPTION =
  "Corrupt text with Unicode combining diacritical marks and adjust glitch intensity.";
const TOOL_META_DESCRIPTION =
  "Free online Zalgo text generator. Corrupt text with Unicode combining diacritical marks, adjust glitch intensity, and strip zalgo effects in real-time.";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: "Zalgo Glitch Text Generator | TwisterTools",
      description: TOOL_META_DESCRIPTION,
      url: canonicalUrl,
