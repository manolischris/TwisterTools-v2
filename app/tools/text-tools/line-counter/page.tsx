...
const TOOL_TITLE = "Text Line Counter & Blank Line Stripper";
const TOOL_SLUG = "line-counter";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Text Line Counter & Blank Line Stripper",
          ...
          <div className="rounded-2xl border border-slate-200 bg-linear-to-br from-slate-50 to-white p-5 shadow-sm dark:border-slate-700 dark:from-slate-900 dark:to-slate-800">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <div className="group relative">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free Text Line Counter & Blank Line Stripper tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
