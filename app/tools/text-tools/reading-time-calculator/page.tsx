...
const TOOL_TITLE = "Reading Time & Speaking Pace Estimator";
const TOOL_SLUG = "reading-time-calculator";
...
const TOOL_META_DESCRIPTION =
  "Estimate silent reading time and speech presentation duration based on word counts and custom WPM speeds. Clean client-side Reading Time Calculator, Speech Pace Calculator, and WPM Estimator.";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: "Reading Time & Speaking Pace Estimator",
    description: TOOL_META_DESCRIPTION,
    keywords: [
      "reading time calculator",
      "speech pace calculator",
      "wpm estimator",
          ...
          <div className="rounded-2xl border border-slate-200 bg-linear-to-br from-slate-50 to-white p-5 shadow-sm dark:border-slate-700 dark:from-slate-900 dark:to-slate-800">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex shrink-0 items-center gap-2">
                ...
                <div className="group relative">
                  <a
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(toolUrl)}&text=${encodeURIComponent("Check out this free Reading Time & Speaking Pace Estimator tool!")}`}
                    target="_blank"
                    rel="noopener noreferrer"
