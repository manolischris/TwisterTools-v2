...
import StrikethroughTextGenerator from "@/components/tools/StrikethroughTextGenerator";
import RelatedTools from "@/components/RelatedTools";
import CopyLinkButton from "@/components/CopyLinkButton";

const TOOL_TITLE = "Strikethrough & Underline Font Styler";
const TOOL_SLUG = "strikethrough-text-generator";
...
const TOOL_META_DESCRIPTION =
  "Free online strikethrough, underline, and overline text styler. Generate cross-platform styled fonts using native Unicode combining characters in real-time.";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: "Strikethrough & Underline Font Styler | TwisterTools",
      description: TOOL_META_DESCRIPTION,
      url: canonicalUrl,
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-10 h-10 sm:w-14 sm:h-14 p-1 sm:p-2 rounded-xl sm:rounded-2xl shrink-0 flex items-center justify-center bg-indigo-50/70 dark:bg-slate-800 shadow-sm">
                <Strikethrough className="w-7 h-7 sm:w-10 sm:h-10 text-indigo-600 dark:text-indigo-400" />
              </div>
