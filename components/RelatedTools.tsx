...
const ICON_MAP: Record<string, any> = {
    ...
    ArrowRightLeft, Clock, QrCode, Combine, Scissors, FileImage, FileType2, Edit3, ListOrdered, Fingerprint, Building, Car, PiggyBank, Activity, Flame, Droplets
};
