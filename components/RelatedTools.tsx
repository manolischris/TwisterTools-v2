...
import { Sparkles, ArrowRight, Code2, Globe, RefreshCw, Calculator, FileText, Lock, Minimize2, Scaling, CreditCard, DollarSign, Percent, Scale, MapPin, Database, ImageIcon, FileCode, Type, Layers, Hash, Calendar, Percent as PercentIcon, Sigma, ArrowLeftRight, ArrowRightLeft, Clock, QrCode, Combine, Scissors, FileImage, FileType2, Edit3, ListOrdered, Fingerprint, Building, Car, PiggyBank, Activity, Flame, Droplets, PieChart, Heart, Baby, Wine, Timer, Grid, GraduationCap } from "lucide-react";
...
const ICON_MAP: Record<string, any> = {
    ...
    ArrowLeftRight, ArrowRightLeft, Clock, QrCode, Combine, Scissors, FileImage, FileType2, Edit3, ListOrdered, Fingerprint, Building, Car, PiggyBank, Activity, Flame, Droplets, PieChart, Heart, Baby, Wine, Timer, Grid, GraduationCap
};
