                            ...
                            <div className="space-y-3.5 p-4 rounded-xl bg-slate-50/70 border border-slate-200">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <span className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-600 dark:text-slate-300 font-semibold text-sm">{currencySymbol}</span>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 min-w-0">
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input aria-label="Current Interest Rate (%)"
                                                type="number"
                                                min="0.1"
                                                max="25"
                                                step="0.125"
                                    ...
                                    <div>
                                        ...
                                        <input aria-label="Years Remaining"
                                            type="number"
                                            min="1"
                                            max="40"
                            ...
                            <div className="space-y-3.5 p-4 rounded-xl bg-indigo-50/40 border border-indigo-100">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 min-w-0">
                                    <div>
                                        ...
                                        <div className="relative">
                                            <input aria-label="New Interest Rate (%)"
                                                type="number"
                                                min="0.1"
                                                max="25"
                                                step="0.125"
                                    ...
                                    <div>
                                        ...
                                        <select aria-label="Select New Term Length"
                                ...
                                <div className="pt-2">
                                    <label className="flex items-center gap-2.5 cursor-pointer text-xs font-semibold text-slate-800 select-none">
                                        <input aria-label="Roll Costs Into Loan"
                                            type="checkbox"
