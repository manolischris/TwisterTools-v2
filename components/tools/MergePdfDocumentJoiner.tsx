                ...
                <div className="space-y-5">
                    <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-4">
                        ...
                        >
                            ...
                            <p className="text-[11px] text-slate-600 dark:text-slate-300">Select multiple PDF documents (Max 20 MB per file)</p>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl border border-slate-200 w-full max-w-3xl overflow-hidden flex flex-col max-h-[85vh]">
                        <div className="px-5 py-4 bg-slate-800 text-white flex items-center justify-between">
                            ...
                            <button
                                ...
                                className="text-slate-600 dark:text-slate-300 hover:text-white p-1"
                            >
                                <X className="w-5 h-5" />
                            </button>
                        </div>
