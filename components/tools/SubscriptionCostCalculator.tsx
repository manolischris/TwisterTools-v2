                    ...
                    <div className="space-y-5">
                        ...
                        <form onSubmit={handleAddSubscription} className="bg-slate-50 border border-slate-200/80 rounded-xl p-4 space-y-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 min-w-0">
                                <div>
                                    ...
                                    <select aria-label="Select Billing Interval"
                                        value={newCycle}
                        ...
                        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 pt-2">
                            <div className="relative flex-1">
                                <Search className="w-3.5 h-3.5 text-slate-600 dark:text-slate-300 absolute left-3 top-1/2 -translate-y-1/2" />
                                <input aria-label="Search active subscriptions"
                                    type="text"
                            ...
                            <select aria-label="Select option" value={filterCategory}
                        ...
                        <div className="space-y-2 max-h-[260px] overflow-y-auto pr-1">
                            {filteredSubscriptions.length === 0 ? (
                                <div className="text-center py-8 text-slate-600 dark:text-slate-300 text-xs border border-dashed border-slate-200 rounded-xl">
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-3">
                                                <div className="text-right">
                                                    ...
                                                    <span className="block text-[10px] text-slate-600 dark:text-slate-300 font-medium">
                                                        {currencySymbol}{annual.toFixed(2)}/yr
                                                    </span>
                                                </div>
                                                <button
                                                    onClick={() => handleDeleteSubscription(sub.id)}
                                                    className="opacity-60 group-hover:opacity-100 hover:text-rose-600 text-slate-600 dark:text-slate-300 p-1.5 rounded-md hover:bg-rose-50 transition cursor-pointer"
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3 max-h-[280px] overflow-y-auto pr-1">
                                    {metrics.categoryTotals.length === 0 ? (
                                        <p className="text-xs text-slate-600 dark:text-slate-300 text-center py-6">No spending data to categorize.</p>
                                    ) : (
                                            ...
                                            <div key={cat.category} className="space-y-1.5">
                                                <div className="flex justify-between text-xs font-semibold text-slate-700">
                                                    ...
                                                    <span>
                                                        ...
                                                        <span className="text-slate-600 dark:text-slate-300 font-normal">({cat.percentage.toFixed(1)}%)</span>
                                                    </span>
                                                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-3 gap-3 text-center">
                                    <div className="p-3 rounded-xl bg-slate-50 border border-slate-200">
                                        <span className="block text-[11px] font-bold text-slate-600 dark:text-slate-300 uppercase">5 Years</span>
