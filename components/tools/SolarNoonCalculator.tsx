                            ...
                            <div className="space-y-1.5">
                                <div className="flex items-center justify-between">
                                    ...
                                    <label className="text-[11px] font-bold text-indigo-600 flex items-center gap-1 cursor-pointer">
                                        <input aria-label="Current Time" type="checkbox"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-slate-700 flex items-center justify-between">
                                    ...
                                    <span className="text-[10px] text-slate-600 dark:text-slate-300 font-mono">-90 to +90</span>
                                </label>
                                <input aria-label="-90 to +90"
                                    type="number"
                                    step="0.0001"
                                    value={latitude}
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-slate-700 flex items-center justify-between">
                                    ...
                                    <span className="text-[10px] text-slate-600 dark:text-slate-300 font-mono">-180 to +180</span>
                                </label>
                                <input aria-label="-180 to +180"
                                    type="number"
                                    step="0.0001"
                                    value={longitude}
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-slate-700 flex items-center justify-between">
                                    ...
                                    <span className="text-[10px] text-slate-600 dark:text-slate-300 font-mono">-12 to +14</span>
                                </label>
                                <input aria-label="-12 to +14"
                                    type="number"
                                    step="0.5"
                                    value={utcOffset}
                        ...
                        <div className="p-4 border border-slate-200 rounded-xl bg-slate-50/70 space-y-3">
                            ...
                            <div className="grid grid-cols-2 gap-3 text-xs">
                                <div className="p-2.5 bg-white border border-slate-200 rounded-lg flex items-center gap-2.5">
                                    ...
                                    <div>
                                        <span className="text-slate-600 dark:text-slate-300 block text-[10px]">Sunrise</span>
                                ...
                                <div className="p-2.5 bg-white border border-slate-200 rounded-lg flex items-center gap-2.5">
                                    ...
                                    <div>
                                        <span className="text-slate-600 dark:text-slate-300 block text-[10px]">Sunset</span>
                                        <span className="font-mono font-bold text-slate-900">
