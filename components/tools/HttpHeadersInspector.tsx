              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    />
                    <Globe className="w-4 h-4 text-slate-600 dark:text-slate-300 absolute left-3.5 top-3.5" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <select aria-label="Select HTTP Method"
                      value={method}
                ...
                <div className="space-y-1.5">
                  ...
                  <input aria-label="User Agent Identifier"
                    type="text"
                    value={userAgent}
