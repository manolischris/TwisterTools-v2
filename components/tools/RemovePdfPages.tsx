                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    className="px-3 py-2 bg-slate-900 hover:bg-slate-800 disabled:bg-slate-100 disabled:text-slate-600 dark:text-slate-300 text-white font-semibold text-xs rounded-xl transition-all"
                                >
                                    Apply Range
                                </button>
                            </div>
