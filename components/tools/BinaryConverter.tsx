          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden">
            ...
            <button
              ...
              className={`w-full py-3 px-4 rounded-xl font-bold text-sm tracking-wide transition-all duration-200 flex items-center justify-center gap-2 shadow-sm min-h-[44px] ${!output
                ? "bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 cursor-not-allowed border border-slate-200 dark:border-slate-700"
                : copied
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between gap-1 overflow-hidden">
                        ...
                        <button
                          ...
                          className="p-1 rounded bg-white hover:bg-indigo-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:text-indigo-600 transition-colors"
